...
LANGS = ["en", "es", "pt", "fr", "de", "it", "ru", "ja", "ko", "tl", "sv", "ceb", "ar", "he", "uk", "pl", "zh-Hans", "zh-Hant", "yue-Hant", "vi", "hu", "hi", "id"]
RTL_LANGS = {"ar", "he"}
...
LOCALE = {
    ...
    "zh-Hans": "zh_CN", "zh-Hant": "zh_TW", "yue-Hant": "zh_HK", "vi": "vi_VN", "hu": "hu_HU", "hi": "hi_IN", "id": "id_ID",
}
