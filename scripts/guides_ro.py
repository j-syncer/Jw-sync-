...
GUIDES_RO = {
 ...
 "import-markdown-notes-jw-library": {
  "title": "Cum imporți notițe Markdown în JW Library",
  "h1": "Cum imporți notițe Markdown în JW Library",
  "description": "Transformă fișierele .md din Obsidian, Notion sau orice editor Markdown în notițe reale JW Library, așezate pe versetul potrivit — gratuit, privat, în browserul tău.",
  "intro": [
  ...
  "steps": [
   ("Creează o copie de rezervă în JW Library",
   ...
   ("Deschide Exploratorul de studiu",
   ...
   ("Citește rezumatul înainte să se scrie ceva",
  ...
  "sections": [
   ("Cel mai scurt fișier care funcționează",
    "Un fișier Markdown nu are nevoie de nimic ca să fie importat: un fișier care conține doar text devine tot o notiță și își ia titlul din primul titlu intern sau, în lipsa lui, din numele fișierului. Restul servește la a spune unde aparține notița. Un fișier complet arată așa:\n\n---\ntitle: Paharul pentru care s-a rugat\ntags: [studiu, ghetsimani]\npublication: Matthew 26:39\n---\n\nRugăciunea lui arată supunere, nu reținere.\n\nBlocul dintre cele două rânduri de liniuțe se numește front matter. Rândurile de dedesubt sunt notița propriu-zisă."),
   ...
   ("Ce se întâmplă când ceva nu e clar",
    "Nimic nesigur nu se decide în locul tău. Dacă numele unei cărți seamănă cu unul real, dar nu este exact — `Mathew`, `Ecclesiates` — notița nu este așezată automat. Apare în rezumat pe rândul ei, spunând cum a citit site-ul: „citit ca Matthew 26:39”, cu o bifă. Debifează și rămâne pe dinafară; las-o bifată și ajunge unde scrie rândul.\n\nDacă nu se recunoaște deloc cartea, rândul spune asta, iar notița este adăugată ca notiță de sine stătătoare — niciodată forțată pe o presupunere. O carte numerotată își păstrează numărul, așa că `1 Jonh` poate fi corectat doar în 1 Ioan, niciodată în 2 Ioan."),
 ...
 "write-markdown-notes-for-jw-library": {
  "title": "Cum să scrii un fișier Markdown care se importă în JW Library",
  "h1": "Cum să scrii un fișier Markdown care se importă în JW Library",
  "description": "Scrie o notiță în Notepad, TextEdit sau Obsidian și fă-o să ajungă pe versetul potrivit în JW Library. Exact ce rânduri să tastezi și tot ce poți lăsa deoparte.",
  "intro": [
  ...
  "steps": [
   ("Deschide orice editor de text simplu",
   ...
   ("Adaugă rândul care o așază pe un verset",
   ...
   ("Importă-l într-o copie de rezervă",
