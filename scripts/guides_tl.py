...
GUIDES_TL["import-markdown-notes-jw-library"] = {
  "title": "Paano mag-import ng mga talang Markdown sa JW Library",
  "h1": "Paano mag-import ng mga talang Markdown sa JW Library",
  "description": "Gawing tunay na tala ng JW Library ang mga .md file mula sa Obsidian, Notion o kahit anong Markdown editor, nakalapat sa tamang talata — libre, pribado, sa loob ng browser mo.",
  "intro": [
   "Walang paraan ang JW Library para magpasok ng teksto. Puwede kang sumulat ng tala sa loob ng app, pero ang talang isinulat sa ibang lugar — sa Obsidian, sa Notion, sa isang plain text file sa computer — ay walang anumang daan papasok sa aklatan mo. Nagre-retype ang mga tao, o sumusuko na lang at nagkakaroon ng dalawang set ng talang pag-aaral na hindi nagtatagpo kailanman.",
   "Sinasara ito ng JW Sync. Mag-load ng backup sa Study Explorer, pindutin ang “Mag-import ng Markdown”, at magiging tunay na tala sa loob nito ang mga .md file mo: buo ang pamagat, petsa at mga tag — at kapag sinasabi ng file kung saang teksto ito nauukol, nakakabit ito sa mismong talatang iyon, na parang isinulat mo ang tala sa app habang binabasa mo ito.",
   "Gumagana ito sa dalawang direksyon. Ang mga talang na-export mula sa site na ito ay may dalang aklat, kabanata at talata, kaya bumabalik sila nang tumpak sa pinanggalingan nila. Ang mga talang isinulat sa ibang lugar ay karaniwang wala nito, kaya ipinapaliwanag ng pahinang ito ang isa o dalawang linyang naglalapat sa kanila — at kung ano ang mangyayari kapag wala ang mga iyon sa file.",
  ],
  "steps": [
   ("Gumawa ng backup sa JW Library",
    "Buksan ang JW Library, pumunta sa Personal na Pag-aaral, pindutin ang tatlong-tuldok na menu, piliin ang Backup and Restore, tapos Create a backup. Magkakaroon ka ng .jwlibrary file — ang aklatang pagdadagdagan ng mga tala mo."),
   ("Buksan ang Study Explorer",
    "Pumunta sa jwsync.org, buksan ang Study Explorer at i-load ang .jwlibrary file na iyon. Lahat ay nangyayari sa loob ng browser mo; hindi kailanman ina-upload ang file."),
   ("Pindutin ang “Mag-import ng Markdown”",
    "Nasa tabi ito ng “I-export ang Markdown”. Pumili ng kahit ilang .md file, o ng isang .zip na naglalaman ng mga ito — pati na ang .zip na ginagawa ng site kapag nag-export ka."),
   ("Basahin ang buod bago may maisulat",
    "Sinasabi sa iyo kung ilan ang dadapo sa isang talata, ilan ang idadagdag bilang malayang tala, at ilan ang nasa backup mo na kaya lalaktawan. Anumang kinailangang bigyang-kahulugan ng site ay nakalista isa-isa, may kahon na matsetsekan, kaya ikaw ang magpapasya sa halip na matuklasan mo na lang pagkatapos."),
   ("Mag-export at mag-restore",
    "Pindutin ang “I-export ang .jwlibrary”, tapos i-restore ang file na iyon sa JW Library sa pamamagitan ng Backup and Restore → Restore. Bahagi na ng aklatan mo sa device na iyon ang mga na-import na tala."),
  ],
  "sections": [
   ("Ang pinakamaikling file na gumagana",
    "Walang kailangan ang isang Markdown file para ma-import: ang file na puro teksto lang ay nagiging tala rin, at kinukuha ang pamagat mula sa unang heading o, kung wala, sa pangalan ng file. Ang lahat ng iba pa ay para sabihin kung saan nauukol ang tala. Ganito ang isang kumpletong file:\n\n---\ntitle: Ang kopang ipinanalangin niya\ntags: [pag-aaral, getsemani]\npublication: Matthew 26:39\n---\n\nPagpapasakop ang ipinapakita ng panalangin niya, hindi pag-aatubili.\n\nAng bahagi sa pagitan ng dalawang linya ng gitling ay tinatawag na front matter. Ang mga linya sa ibaba nito ang mismong tala."),
   ("Ang mga field na binabasa",
    "Limang bagay lang ang binabasa, at bawat isa ay tumatanggap ng ilang baybay para hindi mo na kailangang tandaan ang eksaktong pangalan. Ang **title** (o name, heading) ang nagiging pamagat ng tala. Ang **tags** (o tag, keywords, categories, labels, topics) ay nagiging tunay na tag ng JW Library, at ginagawa kung wala pa. Ang **date** (o created, modified) ang nagtatakda ng petsa; nauunawaan ang anumang naglalaman ng YYYY-MM-DD. Ang **publication** (o pub, reference, ref, scripture, citation, source, passage) ang lalagyan mo ng teksto. Ang **book**, **chapter** at **verse** (o ch, v, vs, verses) ay ganoon din, hiwa-hiwalay lang ang field. Ang anumang ibang field na itinatago mo para sa sarili mong gamit — may-akda, katayuan, kung ano ang idinadagdag ng editor mo — ay hindi pinapansin sa halip na ituring na mali."),
   ("Tatlong paraan para ituro ang tala sa isang talata",
    "Isulat ang teksto sa isang linya: `publication: Matthew 26:39`. O hatiin: `book: Matthew`, `chapter: 26`, `verse: 39`. O gamitin ang dalawa — iyan ang ginagawa ng export ng site na ito, para madaling basahin ng tao at eksaktong mabasa ng makina. Pareho ang resulta ng tatlo, kaya gamitin kung alin ang bagay sa editor mo."),
   ("Gaano kaluwag ang pagbasa sa teksto",
    "Maluwag ang pagtutugma sa pangalan ng aklat. Gumagana ang buong pangalan, gayundin ang mga daglat na talagang tinitipa ng mga tao: Matt, Matt., Mt, 1 Cor, 1Cor, I Corinthians, Second Timothy, Psalm pati Psalms, Song of Songs pati Song of Solomon. Ang pagitan ng kabanata at talata ay puwedeng tutuldok, tuldok o ang titik v — pareho ang pagbasa sa `John 3:16`, `John 3.16` at `1 Cor 13 v4`. Opsyonal ang mga espasyo, kaya tanggap din ang `1Cor13:4`.\n\nGanoon din kaluwag ang front matter mismo. Puwedeng malaki ang unang titik ng mga field. Puwedeng walang espasyo pagkatapos ng tutuldok. Hindi pinapansin ang sobrang espasyo at tab, ang panipi sa paligid ng halaga, at ang # komento sa dulo. Walang problema ang mga line ending ng Windows. Puwede mo pang tanggalin nang tuluyan ang mga linyang --- at simulan ang file mismo sa mga field, basta ang pinakaunang linya ay isa sa mga kilalang pangalan — umiiral ang panuntunang ito para ang talang nagsisimula sa ordinaryong pangungusap na may tutuldok ay hindi mawalan ng unang talata."),
   ("Mga tag, kahit paano mo isulat",
    "Lahat ng ito ay nagbubunga ng parehong dalawang tag: `tags: [pag-aaral, griyego]`, `tags: pag-aaral, griyego`, `tags: pag-aaral; griyego`, `tags: #pag-aaral #griyego`, o isang listahan sa sariling mga linya sa ilalim ng `tags:` na ang bawat entry ay nagsisimula sa gitling. Ang mga tag na nasa aklatan mo na ay ginagamit ulit sa halip na dumoble, kaya sumasama ang na-import na tala sa mismong tag na ginagamit mo nang pang-filter."),
   ("Ano ang nangyayari kapag may hindi malinaw",
    "Walang pinagdududahang bagay na ipinapasya para sa iyo. Kung ang pangalan ng aklat ay malapit sa totoo pero hindi eksakto — `Mathew`, `Ecclesiates` — hindi awtomatikong inilalapat ang tala. Lumilitaw ito sa buod sa sariling linya nito na sinasabi kung paano binasa ng site: “binasa bilang Matthew 26:39”, may kahon na matsetsekan. Alisan ng tsek at hindi ito isasama; iwanang nakatsek at pupunta ito kung saan sinasabi ng linya.\n\nKung hindi talaga makilala ang aklat, sinasabi iyon ng linya at idinadagdag ang tala bilang malayang tala — hindi kailanman pinipilit sa isang hula. Pinapanatili ng bilang na aklat ang bilang nito, kaya ang `1 Jonh` ay maitatama lang bilang 1 Juan, hindi kailanman 2 Juan."),
   ("Ang sinasadyang hindi nito ginagawa",
    "Ang saklaw ng talata ay nakaangkla sa unang talata: inilalagay ng `Matthew 26:39-41` ang tala sa talata 39, dahil ang tala sa JW Library ay nakakabit sa isang punto ng teksto at hindi sa isang saklaw. Ang tekstong may kabanata pero walang talata — `Matthew 26` — ay ikinakabit sa kabanatang iyon. Ang file na nagbabanggit ng publikasyon sa halip na teksto — `The Watchtower—2023 No. 4` — ay ini-import bilang ordinaryong malayang tala nang walang itinatanong, dahil iyon mismo ang isinusulat ng export ng site para sa mga talang kinuha sa isang artikulo."),
   ("Ang pormat na nakakaligtas sa biyahe",
    "Ang mga talata, line break, **bold**, *italic* at bulleted list ay dumarating bilang tunay na pormat sa JW Library. Ang heading sa itaas ng file ay ginagamit bilang pamagat ng tala sa halip na ulitin sa loob. Ang anumang kayang ipahayag ng Markdown na hindi kaya ng tala sa JW Library — mga talahanayan, larawan, link, code block — ay pinapaliit sa teksto nito, kaya walang salitang nawawala kahit hindi madala ang ayos."),
   ("Kung saan talaga napupunta ang mga tala, at bakit ligtas iyon",
    "Para ikabit ang tala sa isang talata, kailangan ng JW Library ang mga panloob na identifier para sa kabanatang iyon na natatangi sa aklatan mo. Hindi kailanman ito iniimbento ng JW Sync. Ginagamit nito ang lokasyong mayroon na ang sarili mong backup para sa kabanatang iyon, o kinokopya ang mga identifier na iyon mula sa ibang lokasyon ng Bibliya sa loob ng parehong file. Kung ang backup ay walang anumang tala o highlight sa Bibliya, walang makokopyahan — kaya idinadagdag ang mga tala bilang malayang tala sa halip na ikabit sa isang bagay na baka hindi makilala ng app. Sinadya ito: mas masahol ang talang tahimik na napunta sa maling lugar kaysa sa talang malinaw na dumating na walang kabit."),
   ("Pag-import ng parehong file nang dalawang beses",
    "Itinuturing nang nandiyan na ang tala kapag tugma ang pamagat, teksto at kinalalagyan nito sa isang bagay sa backup, kaya ang muling pag-import ng parehong export ay hindi dumodoble ng anuman. Sinasabi ng buod kung ilan ang lalaktawan dahil doon bago ka magkumpirma. Ang lahat ng idinadagdag ng isang import ay iisang hakbang ng Undo, at may tag na Imported ang mga na-import na tala para mahanap, ma-filter o matanggal mo sila nang sabay-sabay pagkatapos."),
  ],
  "faq": [
   ("Kailangan ko bang gamitin ang mga linyang ---?",
    "Hindi. Ginagawa nilang malinaw ang file at naiintindihan ito ng bawat Markdown editor, pero puwede mo ring simulan ang file mismo sa mga field — `title: …` sa unang linya — o laktawan ang front matter at hayaang kunin ng tala ang pamagat mula sa unang heading."),
   ("Paano kung mali ang baybay ko sa pangalan ng aklat?",
    "Karaniwang nauunawaan ng site ang ibig mong sabihin, pero hindi ito kumikilos batay lang doon. Lumilitaw ang tala sa buod na may nakasaad kung paano ito binasa, may kahon na matsetsekan, kaya ikaw ang magkukumpirma bago may maisulat."),
   ("Puwede bang mag-import ng buong folder mula sa Obsidian?",
    "Pumili ng kahit ilang .md file nang sabay, o i-zip ang folder at piliin ang .zip. Ang mga file sa loob ay binabasa katulad ng mga hiwalay na file."),
   ("Mapapalitan ba ng import ang mga talang mayroon na ako?",
    "Hindi. Nagdaragdag lang ang import. Hindi ginagalaw ang kasalukuyang mga tala, highlight, bookmark at tag mo, at hindi kailanman binabago ang file na ni-load mo — isang bagong .jwlibrary ang ida-download mo sa dulo."),
   ("Ina-upload ba ang mga tala ko kahit saan?",
    "Hindi. Sa browser mo tumatakbo ang lahat, tulad ng iba pang bahagi ng site. Hindi umaalis sa device mo ang backup at ang mga Markdown file mo."),
   ("Anong wika ang puwede kong gamitin sa teksto?",
    "Sa ngayon ay Ingles ang pagkilala sa pangalan ng aklat, na siya ring isinusulat ng export. Kung sa ibang wika ka sumusulat ng tala, gamitin ang `book`, `chapter` at `verse` na may pangalang Ingles ng aklat, o i-import ang mga tala nang walang kabit at ilagay sa lugar nang manu-mano mamaya."),
   ("Mailalabas ko ba ulit ang mga tala ko?",
    "Oo — ang “I-export ang Markdown” sa parehong screen ay isinusulat ang bawat tala sa isang .md file na may parehong field, kaya makakalabas ang mga tala sa JW Library at makakabalik nang hindi nawawala kung saan sila nauukol."),
  ],
}

GUIDES_TL["write-markdown-notes-for-jw-library"] = {
  "title": "Paano gumawa ng Markdown file na puwedeng i-import sa JW Library",
  "h1": "Paano gumawa ng Markdown file na puwedeng i-import sa JW Library",
  "description": "Sumulat ng tala sa Notepad, TextEdit o Obsidian at ihulog ito sa tamang teksto sa JW Library. Ang eksaktong mga linyang ita-type, at lahat ng puwede mong laktawan.",
  "intro": [
   "Kayang basahin ng JW Sync ang mga Markdown file papasok sa isang backup ng JW Library, at iyon ang nagdudulot ng tanging tanong na talagang mahalaga kapag alam mo nang may ganitong tampok: ano ba dapat ang itsura ng file? Sinasagot ito ng pahinang ito mula sa panig ng sumusulat — hindi kung ano ang tinatanggap ng pag-import, kundi kung ano ang aktuwal mong tini-type.",
   "Sa maikling salita, ang isang tala ay isang text file. Gumawa ng file, isulat ang tala, i-save nang nagtatapos sa .md, at mai-import na iyon. Ang lahat ng iba pa rito ay tungkol sa isang opsiyonal na linya: iyong nagsasabi kung saang teksto nabibilang ang tala, para lumitaw ito sa JW Library habang binabasa mo ang tekstong iyon sa halip na maiwang nakahiwalay sa gitna ng iba mong tala.",
   "Wala rito ang nangangailangan ng Markdown editor, at wala ring nangangailangan na matuto ka ng Markdown. Sapat na ang Notepad sa Windows at TextEdit sa Mac. Kung nasa Obsidian o Notion na ang mga tala mo sa pag-aaral, Markdown na ang mga file na iyon, at may sariling bahagi ang bawat isa sa ibaba.",
  ],
  "steps": [
   ("Magbukas ng kahit anong plain text editor",
    "Notepad sa Windows, TextEdit sa Mac, o ang Markdown app na ginagamit mo na — Obsidian, Typora, iA Writer, Joplin. Ang tanging dapat iwasan ay word processor: nagse-save ang Word at Google Docs ng anyo at disenyo sa halip na plain text, at wala sa dalawa ang gumagawa ng file na kayang basahin ng pag-import."),
   ("I-type ang tala",
    "Ilagay ang pamagat sa unang linya na may # sa unahan, mag-iwan ng blangkong linya, at isulat ang tala sa ibaba. Kumpleto at wasto nang file iyon. Kung ayaw mong magsulat ng linya ng pamagat, ang pangalan ng file ang gagamitin."),
   ("I-save ito nang nagtatapos sa .md",
    "Pangalanan mo kung ano ang gusto mo — aking tala.md. Sa Windows, .txt ang isi-save ng Notepad hangga't hindi mo muna binabago ang “Save as type” tungo sa “All Files”, at iyan ang pinakamadalas na mapagkamalian. Sa Mac, piliin ang Format at pagkatapos ang Make Plain Text bago mag-save."),
   ("Idagdag ang linyang naglalagay nito sa isang teksto",
    "Sa pinakaitaas ng file, bago ang lahat, magsulat ng linyang may tatlong gitling, tapos publication: Matthew 26:39, tapos tatlong gitling ulit. Nakakabit na ngayon ang tala sa tekstong iyon. Kung laktawan mo ito, mai-import pa rin ang tala — dumarating lang itong walang kakabitan."),
   ("I-import ito sa isang backup",
    "Sa JW Library, pumunta sa Personal na Pag-aaral, buksan ang tatlong-tuldok na menu, piliin ang Backup and Restore at gumawa ng backup. I-load ang file na iyon sa jwsync.org, sa Study Explorer, pindutin ang “Mag-import ng Markdown”, piliin ang iyong mga .md file, at basahin ang buod na ipapakita bago may maisulat. Pagkatapos, pindutin ang “I-export ang .jwlibrary” at i-restore ang file na iyon sa JW Library."),
  ],
  "sections": [
   ("Ang pinakamaikling file na gumagana",
    "Ang file na walang laman kundi teksto ay wasto nang tala. Ito lang ang buong laman:\n\n```\n# Ang kopang ipinanalangin niya\n\nPagpapasakop ang ipinapakita ng panalangin niya, hindi pag-aatubili.\n```\n\nAng linyang nagsisimula sa # ang nagiging pamagat ng tala, at lahat ng nasa ilalim nito ang nagiging tala. Nai-import ang file na iyon nang walang reklamo. Dumarating lang itong nakahiwalay na tala, kasama ng iba mong tala sa halip na nakakabit sa isang teksto."),
   ("Paggawa ng file sa Windows",
    "Buksan ang Notepad, i-type ang tala, tapos piliin ang File at Save as. Bago mag-save, baguhin ang “Save as type” mula “Text Documents” tungo sa “All Files” — kung walang hakbang na iyan, tahimik na idadagdag ng Notepad ang .txt at ang matitira sa iyo ay aking tala.md.txt, na hindi makikita ng pag-import. Pagkatapos, i-type ang pangalan na nagtatapos sa .md. Baka magbabala ang Windows na maaaring hindi na magamit ang file kapag pinalitan ang extension; ang babalang iyon mismo ang tanda na tama ang ginawa mo."),
   ("Paggawa ng file sa Mac",
    "Buksan ang TextEdit at piliin ang Format at pagkatapos ang Make Plain Text bago mag-type ng kahit ano. Nagsisimula ang TextEdit sa rich text mode at nagse-save ng .rtf, na hindi naman talaga text file. Kapag nasa plain text mode na, piliin ang File at Save, at tapusin ang pangalan sa .md. Kung mag-alok ang macOS na idagdag ang .txt, tanggihan mo."),
   ("Paggawa ng file sa telepono o tablet",
    "Puwede ang kahit anong app na kayang mag-save o mag-export ng Markdown — Obsidian, Bear, iA Writer, Joplin, Markor sa Android. Karaniwang hindi kayang mag-save ng .md file ng mga Notes app na kasama na sa iPhone at Android, kaya sa telepono, ang karaniwang daan ay isa sa mga app na iyon, o basta't magsulat na lang sa kompyuter. Kapag nag-import ka, puwede kang pumili ng kasindami ng gusto mong file nang sabay-sabay, at puwedeng i-zip ang buong folder at ibigay bilang isang .zip."),
   ("Ang isang linyang naglalagay ng tala sa isang teksto",
    "Lahat ng nagsasabi sa pag-import kung saan nabibilang ang tala ay nasa maliit na bloke sa pinakaitaas ng file, sa pagitan ng dalawang linya ng tatlong gitling. Tinatawag itong front matter, at sa karamihan ng tala ay isang linya lang ito:\n\n```\n---\npublication: Matthew 26:39\n---\n\n# Ang kopang ipinanalangin niya\n\nPagpapasakop ang ipinapakita ng panalangin niya, hindi pag-aatubili.\n```\n\nNakakabit na ngayon ang talang iyon sa Mateo 26:39. Lumilitaw ito sa JW Library habang binabasa mo ang tekstong iyon, gaya mismo ng kung isinulat mo ito roon sa app."),
   ("Pagsulat ng reperensiya nang maiintindihan",
    "Isulat sa Ingles ang pangalan ng aklat, kahit iba ang wika ng mismong tala: Matthew, hindi Mateo. Naiintindihan din ang mga daglat na talagang tini-type ng mga tao — Matt, Matt., Mt, 1 Cor, 1Cor, I Corinthians, Second Timothy. Sa pagitan ng kabanata at teksto, puwedeng tutuldok, tuldok, o ang letrang v, kaya iisa ang ibig sabihin ng John 3:16, John 3.16 at 1 Cor 13 v4, at opsiyonal ang mga espasyo, kaya puwede rin ang 1Cor13:4. Ang saklaw na gaya ng Matthew 26:39-41 ay naglalagay ng tala sa unang teksto, ang 39, dahil ang tala sa JW Library ay kumakabit sa isang punto ng teksto at hindi sa isang saklaw."),
   ("Ang buong file, may pamagat, petsa at tag",
    "May tatlo pang linyang puwede kung gusto mo, at opsiyonal silang lahat:\n\n```\n---\ntitle: Ang kopang ipinanalangin niya\ndate: 2026-08-15\ntags: [pag-aaral, getsemani]\npublication: Matthew 26:39\n---\n\nPagpapasakop ang ipinapakita ng panalangin niya, hindi pag-aatubili.\n```\n\nGanoon din ang ginagawa ng title gaya ng ulong may #, kaya isa lang sa dalawa ang kailangan. Itinatakda ng date ang petsa ng tala sa halip na iwan ang araw ng pag-import. Nagiging tunay na tag sa JW Library ang tags na puwede mong pagsalain, at ang tag na mayroon ka na ay ginagamit ulit sa halip na doblehin. Puwede ring isulat ang linyang tags bilang pag-aaral, getsemani nang walang panaklong, o #pag-aaral #getsemani, o bilang listahang may gitling sa magkakahiwalay na linya sa ibaba — pare-pareho ang basa sa apat."),
   ("Isang tala bawat file",
    "Nagiging isang tala ang bawat .md file. Walang paraan para maglagay ng ilang tala sa iisang file at paghiwa-hiwalayin sila, dahil walang anuman sa isang Markdown file ang maaasahang nagtatanda kung saan nagtatapos ang isang tala at nagsisimula ang susunod — ang ulo sa gitna ay puwedeng pangalawang tala o puwede ring pang-ilalim na ulo ng una, at kung mali ang hula ay makakalat ang isinulat mo. Kaya sumulat ng isang file bawat tala, tapos piliin silang lahat nang sabay kapag nag-i-import, o i-zip ang folder at piliin ang .zip."),
   ("Ang anyong buo pa rin pagdating",
    "Dumarating sa JW Library bilang tunay na anyo ang mga talata, pagpapatid ng linya, bold, italic at bulleted na listahan. Ang mga ulo pagkatapos ng una ay nagiging karaniwang talata. Anumang kayang ipahayag ng Markdown na hindi kaya ng tala sa JW Library — mga talahanayan, larawan, link, code block — ay pinapaliit tungo sa teksto nito, kaya nananatili ang mga salita kahit hindi makasunod ang disenyo."),
   ("Kung nagsusulat ka na sa Obsidian",
    "Markdown na ang mga file ng Obsidian, at ang Properties panel nito ay eksaktong nagsusulat ng front matter na inilalarawan dito: magdagdag ng property na tinatawag na publication na may halagang Matthew 26:39, at doon dadapo ang tala. Ang sariling property na tags ng Obsidian ay binabasa bilang tags. Ang mga link na nasa dobleng kuwadradong panaklong at ang mga naka-embed na tala ay pinapaliit tungo sa teksto nila, dahil walang matuturo ang mga iyon sa isang tala ng JW Library. Puwede mong piliin ang mga .md ng buong folder sa isang pag-import, o i-zip ang folder at ibigay ang .zip."),
   ("Kung nagsusulat ka na sa Notion",
    "Kayang mag-export ng Markdown ng Notion: buksan ang menu ng pahina, piliin ang Export, at piliin ang “Markdown & CSV”. Ang lumalabas ay .zip, na tinatanggap ng pag-import kung ano ito. Isinusulat ng Notion ang pamagat ng pahina bilang ulo at ang sarili nitong mga property bilang karaniwang linya sa ilalim, at ang mga field na hindi nakikilala ng pag-import ay binabalewala sa halip na ituring na mali — kaya para mailagay ang tala sa isang teksto, ikaw na mismo ang magdagdag ng linyang publication sa itaas ng na-export na file."),
   ("Mga bagay na hindi mo kailangang matamaan nang tama",
    "Walang kuwenta ang malalaking titik sa pangalan ng mga field. Puwedeng wala ang espasyo pagkatapos ng tutuldok. Binabalewala ang sobrang espasyo at tab, gayundin ang panipi sa palibot ng halaga at ang komentong nakasulat pagkatapos ng #. Ayos lang ang mga hangganan ng linya ng Windows. Puwede mo pa ngang tanggalin nang tuluyan ang mga linyang --- at simulan agad ang file sa mga field, basta't isa sa kanila ang pinakaunang linya. At kung mali ang baybay mo sa pangalan ng aklat — Mathew — sasabihin sa iyo ng pag-import na binasa niya iyon bilang Matthew 26:39 at maghihintay siyang lagyan mo ng tsek ang kahon, sa halip na magpasiya nang mag-isa."),
   ("Ang hindi gagawin ng pag-import sa aklatan mo",
    "Nagdaragdag lang ang pag-import. Hindi ginagalaw ang mga tala, highlight, bookmark at tag na nasa backup mo na, at hindi kailanman binabago ang file na ini-load mo — sa huli ay magda-download ka ng bagong .jwlibrary at iyon ang ire-restore mo. Nilalaktawan ang talang ang pamagat, teksto at lugar ay tugmang-tugma sa isang bagay na nasa backup na, kaya ang pag-import ng parehong file nang dalawang beses ay walang idinodoble. Ang lahat ng idinaragdag ng pag-import ay isang hakbang lang ng Undo, at may tag na Imported ang mga na-import na tala, kaya mahahanap, masasala o matatanggal mo sila bilang grupo pagkatapos. Wala rito ang umaalis sa device mo."),
  ],
  "faq": [
   ("Kailangan ko bang matuto muna ng Markdown?",
    "Hindi. Wasto nang tala ang file na puro karaniwang pangungusap. Pumapasok lang ang Markdown kung gusto mo ng bold, italic o bullet, at kahit doon ay dalawang asterisk lang sa palibot ng salita para sa bold at isang gitling sa simula ng linya para sa bullet."),
   ("May kinalaman ba ang pangalan ng file?",
    "Kapag lang walang sariling pamagat ang file. Kung walang linyang title: at walang ulong may #, nililinis ang pangalan ng file at iyon ang ginagamit, kaya ang ang-kopang-ipinanalangin-niya.md ay nagiging talang “ang kopang ipinanalangin niya”. Kung hindi naman, pangalanan mo ang file kung ano ang gusto mo."),
   ("Paano kung na-save ko itong .txt nang hindi sinasadya?",
    "Palitan ang pangalan para magtapos ito sa .md at i-import ulit — walang kailangang baguhin sa laman. Sa Windows, baka kailangan mo munang buksan ang file name extensions sa View menu ng File Explorer, kung hindi ay nakatago sa iyo ang dulo."),
   ("Puwede ko bang isulat ang pangalan ng aklat sa sarili kong wika?",
    "Sa ngayon ay hindi. Nakikilala ang pangalan ng aklat sa Ingles, at iyon din ang isinusulat ng Markdown export ng site na ito. Isulat ang tala sa kahit anong wikang gusto mo; ang linya lang ng reperensiya ang nangangailangan ng pangalang Ingles. Kung ayaw mo, laktawan ang reperensiya at ikaw na mismo ang maglagay nito sa lugar pagkatapos."),
   ("Puwede ba akong maglagay ng mahigit isang tala sa iisang file?",
    "Hindi — nagiging isang tala ang bawat file. Pumili ng kasindami ng gusto mong file sa isang pag-import, o i-zip ang folder at piliin ang .zip."),
   ("Babaguhin ba nito ang mga talang mayroon na ako?",
    "Hindi. Nagdaragdag lang ang pag-import. Hindi ginagalaw ang dati mong mga tala, at hindi kailanman binabago ang backup na ini-load mo: sa huli ay magda-download ka ng bagong file at ikaw ang magpapasiya kung ire-restore mo ito."),
   ("Ano ang mangyayari kung laktawan ko ang linya ng reperensiya?",
    "Mai-import pa rin ang tala. Dumarating itong nakahiwalay na tala sa aklatan mo sa halip na nakakabit sa isang teksto — na siya namang karaniwang gusto ng talang tungkol sa isang pahayag, isang usapan, o isang personal na kaisipan."),
  ],
}
