...
GUIDES_PL = {
 ...
 "write-markdown-notes-for-jw-library": {
  "title": "Jak napisać plik Markdown, który zaimportuje się do JW Library",
  "h1": "Jak napisać plik Markdown, który zaimportuje się do JW Library",
  "description": "Napisz notatkę w Notatniku, TextEdit lub Obsidianie i spraw, by trafiła na właściwy werset w JW Library. Dokładne linie do wpisania i wszystko, co możesz pominąć.",
  "intro": [
