...
(function () {
  ...
  var WTLOCALE = { en: 'E', es: 'S', pt: 'T', fr: 'F', de: 'X', it: 'I', ru: 'U', ja: 'J', ko: 'KO', tl: 'TG', sv: 'Z', ceb: 'CV', ar: 'A', he: 'Q', uk: 'K', pl: 'P', 'zh-Hans': 'CHS', 'zh-Hant': 'CH', 'yue-Hant': 'CHC', vi: 'VT', hu: 'H', hi: 'HI', id: 'IN', ro: 'M', nl: 'O' };
