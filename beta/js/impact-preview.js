...
(function () {
  ...
  ,sv:{title:"Redo att slå ihop",sub:"Här är vad sammanslagningen ändrar. Granska siffrorna och ladda sedan ner din sammanslagna säkerhetskopia.",added:"Kommer att läggas till",notes:"Anteckningar",highlights:"Överstrykningar",bookmarks:"Bokmärken",tags:"Taggar",updated:"Uppdaterade anteckningar (nyare version vinner)",deduped:"Dubbletter överhoppade",confirm:"Slå ihop och ladda ner",cancel:"Avbryt",study_answers:"Studiesvar",doctor:"Hälsokolla och rensa den sammanslagna filen före nedladdning (Biblioteksdoktorn)"},ceb:{title:'Andam na nga isagol',sub:'Mao kini ang pagbabago sa merge. Susihon ang mga numero, unya i-download ang imong gisagol nga backup.',added:'Iduganon',notes:'Mga nota',highlights:'Mga highlight',bookmarks:'Mga bookmark',tags:'Mga tag',updated:'Na-update nga mga nota (mananaog ang mas bago)',deduped:'Gilaktawan nga mga duplicate',confirm:'Isagol ug i-download',cancel:'Ikansela',study_answers:'Mga tubag sa pagtuon',doctor:'Susiha ug limpyohi ang gisagol nga file una i-download (Library Doctor)'},el:{title:"Έτοιμο για συγχώνευση",sub:"Να τι θα αλλάξει αυτή η συγχώνευση. Ελέγξτε τους αριθμούς και έπειτα κατεβάστε το συγχωνευμένο αντίγραφο ασφαλείας σας.",added:"Θα προστεθούν",notes:"Σημειώσεις",highlights:"Επισημάνσεις",bookmarks:"Σελιδοδείκτες",tags:"Ετικέτες",updated:"Σημειώσεις που ενημερώθηκαν (επικρατεί η νεότερη εκδοχή)",deduped:"Διπλότυπα που παραλείφθηκαν",confirm:"Συγχώνευση και λήψη",cancel:"Ακύρωση",study_answers:"Απαντήσεις μελέτης",doctor:"Έλεγχος υγείας και καθαρισμός του συγχωνευμένου αρχείου πριν από τη λήψη (Γιατρός βιβλιοθήκης)"},sw:{title:"Tayari kuunganisha",sub:"Haya ndiyo mambo ambayo muunganisho huu utabadilisha. Kagua idadi, kisha upakue nakala yako rudufu iliyounganishwa.",added:"Yataongezwa",notes:"Madokezo",highlights:"Viangazio",bookmarks:"Alamisho",tags:"Lebo",updated:"Madokezo yaliyosasishwa (toleo jipya zaidi lashinda)",deduped:"Nakala zilizojirudia zimerukwa",confirm:"Unganisha na Upakue",cancel:"Ghairi",study_answers:"Majibu ya funzo",doctor:"Kagua afya na usafishe faili lililounganishwa kabla ya kupakua (Daktari wa Maktaba)"},nl:{title:"Klaar om samen te voegen",sub:"Dit gaat deze samenvoeging veranderen. Bekijk de aantallen en download daarna je samengevoegde back-up.",added:"Wordt toegevoegd",notes:"Aantekeningen",highlights:"Markeringen",bookmarks:"Bladwijzers",tags:"Labels",updated:"Aantekeningen bijgewerkt (nieuwste versie wint)",deduped:"Dubbele items overgeslagen",confirm:"Samenvoegen en downloaden",cancel:"Annuleren",study_answers:"Studieantwoorden",doctor:"Het samengevoegde bestand controleren en opschonen vóór het downloaden (Library Doctor)"},ro:{title:"Gata de îmbinare",sub:"Iată ce va schimba această îmbinare. Verifică cifrele, apoi descarcă-ți copia de rezervă îmbinată.",added:"Se vor adăuga",notes:"Notițe",highlights:"Evidențieri",bookmarks:"Semne de carte",tags:"Etichete",updated:"Notițe actualizate (câștigă versiunea mai nouă)",deduped:"Duplicate omise",confirm:"Îmbină și descarcă",cancel:"Anulează",study_answers:"Răspunsuri de studiu",doctor:"Verifică starea și curăță fișierul îmbinat înainte de descărcare (Library Doctor)"},id:{title:"Siap digabungkan",sub:"Inilah yang akan berubah dari penggabungan ini. Periksa angkanya, lalu unduh cadangan gabungan Anda.",added:"Akan ditambahkan",notes:"Catatan",highlights:"Sorotan",bookmarks:"Penanda",tags:"Label",updated:"Catatan diperbarui (versi terbaru yang dipakai)",deduped:"Duplikat dilewati",confirm:"Gabungkan & Unduh",cancel:"Batal",study_answers:"Jawaban pelajaran",doctor:"Periksa dan bersihkan berkas gabungan sebelum diunduh (Library Doctor)"},hi:{title:"मर्ज के लिए तैयार",sub:"यह मर्ज क्या बदलेगा, वह यहाँ है। आँकड़े देखें, फिर अपना मर्ज किया बैकअप डाउनलोड करें।",added:"जोड़ा जाएगा",notes:"नोट",highlights:"हाइलाइट",bookmarks:"बुकमार्क",tags:"टैग",updated:"अपडेट हुए नोट (नया वर्शन जीतता है)",deduped:"छोड़ी गई डुप्लिकेट",confirm:"मर्ज करें और डाउनलोड करें",cancel:"रद्द करें",study_answers:"अध्ययन के जवाब",doctor:"डाउनलोड से पहले मर्ज की गई फ़ाइल की जाँच और सफ़ाई करें (Library Doctor)"},hu:{title:"Kész az egyesítésre",sub:"Íme, mit fog megváltoztatni ez az egyesítés. Nézd át a számokat, majd töltsd le az egyesített mentésedet.",added:"Hozzá lesz adva",notes:"Jegyzetek",highlights:"Kiemelések",bookmarks:"Könyvjelzők",tags:"Címkék",updated:"Frissített jegyzetek (az újabb verzió nyer)",deduped:"Kihagyott duplikátumok",confirm:"Egyesítés és letöltés",cancel:"Mégse",study_answers:"Tanulmányozási válaszok",doctor:"Állapotellenőrzés és tisztítás letöltés előtt (Library Doctor)"},vi:{title:"Sẵn sàng hợp nhất",sub:"Đây là những gì lần hợp nhất này sẽ thay đổi. Hãy xem lại các con số, rồi tải bản sao lưu đã hợp nhất về.",added:"Sẽ được thêm",notes:"Ghi chú",highlights:"Phần tô màu",bookmarks:"Dấu trang",tags:"Thẻ",updated:"Ghi chú được cập nhật (bản mới hơn thắng)",deduped:"Đã bỏ qua bản trùng lặp",confirm:"Hợp nhất & tải về",cancel:"Hủy",study_answers:"Câu trả lời học hỏi",doctor:"Kiểm tra và dọn dẹp tập tin đã hợp nhất trước khi tải về (Library Doctor)"},"yue-Hant":{title:"準備好合併",sub:"以下係今次合併會改動嘅嘢。睇過啲數字之後，就可以下載合併好嘅備份。",added:"將會加入",notes:"筆記",highlights:"標註",bookmarks:"書籤",tags:"標籤",updated:"已更新嘅筆記（保留較新嗰個版本）",deduped:"略過咗嘅重複項",confirm:"合併並下載",cancel:"取消",study_answers:"研究答案",doctor:"下載之前檢查同清理合併好嘅檔案（書庫醫生）"},"zh-Hant":{title:"準備合併",sub:"以下是這次合併將帶來的更改。核對資料後，即可下載合併後的備份。",added:"將會新增",notes:"筆記",highlights:"標註",bookmarks:"書籤",tags:"標籤",updated:"已更新的筆記（保留較新的版本）",deduped:"已跳過的重複項",confirm:"合併並下載",cancel:"取消",study_answers:"研究答案",doctor:"下載前檢查並清理合併後的檔案（書庫醫生）"},"zh-Hans":{title:"准备合并",sub:"以下是这次合并将带来的更改。核对数据后，即可下载合并后的备份。",added:"将会新增",notes:"笔记",highlights:"标注",bookmarks:"书签",tags:"标签",updated:"已更新的笔记（保留较新的版本）",deduped:"已跳过的重复项",confirm:"合并并下载",cancel:"取消",study_answers:"研究答案",doctor:"下载前检查并清理合并后的文件（书库医生）"},pl:{title:"Gotowe do scalenia",sub:"Oto co zmieni to scalanie. Przejrzyj liczby, a następnie pobierz scaloną kopię zapasową.",added:"Zostanie dodane",notes:"Notatki",highlights:"Wyróżnienia",bookmarks:"Zakładki",tags:"Etykiety",updated:"Zaktualizowane notatki (wygrywa nowsza wersja)",deduped:"Pominięte duplikaty",confirm:"Scal i pobierz",cancel:"Anuluj",study_answers:"Odpowiedzi do studium",doctor:"Sprawdź stan i wyczyść scalony plik przed pobraniem (Doktor biblioteki)"},uk:{title:"Готово до об'єднання",sub:"Ось що змінить це об'єднання. Перегляньте цифри, а тоді завантажте об'єднану резервну копію.",added:"Буде додано",notes:"Нотатки",highlights:"Виділення",bookmarks:"Закладки",tags:"Теги",updated:"Оновлені нотатки (перемагає новіша версія)",deduped:"Пропущені дублікати",confirm:"Об'єднати і завантажити",cancel:"Скасувати",study_answers:"Відповіді для вивчення",doctor:"Перевірити стан і очистити об'єднаний файл перед завантаженням (Лікар бібліотеки)"},he:{title:"מוכן למיזוג",sub:"הנה מה שהמיזוג הזה ישנה. עברו על המספרים, ואז הורידו את הגיבוי הממוזג.",added:"יתווספו",notes:"הערות",highlights:"הדגשות",bookmarks:"סימניות",tags:"תוויות",updated:"הערות שעודכנו (הגרסה החדשה יותר גוברת)",deduped:"כפילויות שדולגו",confirm:"מיזוג והורדה",cancel:"ביטול",study_answers:"תשובות ללימוד",doctor:"בדיקת תקינות וניקוי הקובץ הממוזג לפני ההורדה (רופא הספרייה)"},ar:{title:"جاهز للدمج",sub:"إليك ما سيغيّره هذا الدمج. راجِع الأرقام، ثم نزّل نسختك الاحتياطية المدمجة.",added:"ستتم إضافته",notes:"ملاحظات",highlights:"تظليلات",bookmarks:"علامات مرجعية",tags:"وسوم",updated:"ملاحظات محدَّثة (تُعتمد النسخة الأحدث)",deduped:"تكرارات تم تخطّيها",confirm:"ادمج ونزّل",cancel:"إلغاء",study_answers:"إجابات الدرس",doctor:"افحص الملف المدمج ونظّفه قبل التنزيل (طبيب المكتبة)"}};
