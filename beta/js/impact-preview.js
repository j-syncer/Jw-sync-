...
(function () {
  ...
  ,sv:{title:"Redo att slå ihop",sub:"Här är vad sammanslagningen ändrar. Granska siffrorna och ladda sedan ner din sammanslagna säkerhetskopia.",added:"Kommer att läggas till",notes:"Anteckningar",highlights:"Överstrykningar",bookmarks:"Bokmärken",tags:"Taggar",updated:"Uppdaterade anteckningar (nyare version vinner)",deduped:"Dubbletter överhoppade",confirm:"Slå ihop och ladda ner",cancel:"Avbryt",study_answers:"Studiesvar",doctor:"Hälsokolla och rensa den sammanslagna filen före nedladdning (Biblioteksdoktorn)"},ceb:{title:'Andam na nga isagol',sub:'Mao kini ang pagbabago sa merge. Susihon ang mga numero, unya i-download ang imong gisagol nga backup.',added:'Iduganon',notes:'Mga nota',highlights:'Mga highlight',bookmarks:'Mga bookmark',tags:'Mga tag',updated:'Na-update nga mga nota (mananaog ang mas bago)',deduped:'Gilaktawan nga mga duplicate',confirm:'Isagol ug i-download',cancel:'Ikansela',study_answers:'Mga tubag sa pagtuon',doctor:'Susiha ug limpyohi ang gisagol nga file una i-download (Library Doctor)'},he:{title:"מוכן למיזוג",sub:"הנה מה שהמיזוג הזה ישנה. עברו על המספרים, ואז הורידו את הגיבוי הממוזג.",added:"יתווספו",notes:"הערות",highlights:"הדגשות",bookmarks:"סימניות",tags:"תוויות",updated:"הערות שעודכנו (הגרסה החדשה יותר גוברת)",deduped:"כפילויות שדולגו",confirm:"מיזוג והורדה",cancel:"ביטול",study_answers:"תשובות ללימוד",doctor:"בדיקת תקינות וניקוי הקובץ הממוזג לפני ההורדה (רופא הספרייה)"},ar:{title:"جاهز للدمج",sub:"إليك ما سيغيّره هذا الدمج. راجِع الأرقام، ثم نزّل نسختك الاحتياطية المدمجة.",added:"ستتم إضافته",notes:"ملاحظات",highlights:"تظليلات",bookmarks:"علامات مرجعية",tags:"وسوم",updated:"ملاحظات محدَّثة (تُعتمد النسخة الأحدث)",deduped:"تكرارات تم تخطّيها",confirm:"ادمج ونزّل",cancel:"إلغاء",study_answers:"إجابات الدرس",doctor:"افحص الملف المدمج ونظّفه قبل التنزيل (طبيب المكتبة)"}};
