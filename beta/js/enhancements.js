...
(function () {
  ...
  function registerServiceWorker() {
    ...
    navigator.serviceWorker.register('../service-worker.js', { scope: '/beta/' })
      .then(function (reg) {
  ...
  // The merge demo now lives in beta/index.html as part of the persistent
  ...
  // The inline "Try Demo" handler in beta/index.html needs to (1) build
  // two synthetic .jwlibrary backups and (2) inject them into the React
  // file pickers separately (main + secondary). Expose helpers here so it
  // doesn't have to duplicate the builder code.
