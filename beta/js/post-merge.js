...
(function () {
  ...
  var SAFE_I18N={
   ...
   ceb:{safe_title:'Pag-restore nga luwas',safe_originals:'Luwas ang imong orihinal nga mga backup — dili kini usbon sa JW Sync. Kini usa ka bag-ong gihiusa nga file.',safe_master:'Tipigi kini nga gihiusa nga file isip imong master backup.'},he:{safe_title:"שחזור בבטחה",safe_originals:"הגיבויים המקוריים שלכם בטוחים — JW Sync לעולם לא משנה אותם. זהו קובץ מאוחד חדש לגמרי.",safe_master:"שמרו את הקובץ המאוחד הזה כגיבוי הראשי שלכם."},ar:{safe_title:"استعادة آمنة",safe_originals:"نسخك الاحتياطية الأصلية في أمان — JW Sync لا يغيّرها أبدًا. هذا ملف مدمج جديد تمامًا.",safe_master:"احتفظ بهذا الملف المدمج بوصفه نسختك الاحتياطية الرئيسية."}
  };
