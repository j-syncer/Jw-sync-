...
(function(){
  ...
  // ---------- Markdown import ----------
  // "Publication", " pub ", "Bible reference" and "scripture" all mean the same
  ...
  // Abbreviations people actually type. Everything is compared after
  ...
  // Front matter as people actually write it. The fences may be missing, the
  ...
  // Does this backup contain any Bible location we could copy the identity
  ...
  function resolveBibleLocationId(bookNumber, chapter, cache, create){
  ...
  function importMdNotes(items){
    ...
    try{
      ...
      items.forEach(function(it){
        try{
          // Anchor only on a reference we actually resolved. Anything the
          ...
          var verse=(locId&&ref&&ref.verse)?ref.verse:null;
  ...
  function buildOverlay(){
    ...
    var mdiBtn=document.createElement('button'); mdiBtn.className='jb-md-btn'; mdiBtn.type='button';
