...
(function () {
  ...
  var I18N = {
    ...
    ceb: { brand: 'Balikan', on_this_day: 'Niini nga adlaw', w_years: 'Gisulat {n} ka tuig na ang milabay', w_year: 'Gisulat usa ka tuig na ang milabay', w_months: 'Gisulat {n} ka bulan na ang milabay', w_month: 'Gisulat niadtong miaging bulan', w_recent: 'Bag-o lang gisulat', count_sep: 'sa', reflect: 'Markahi nga nasusi', next: 'Sunod', done_title: 'Naapsan na nimo', done_sub: 'Nasusi na nimo ang mga nota karong adlawa. Gamay apan kanunay — mao kini ang paagi nga magpabilin ang pagtuon.', come_back: 'Balik ugma para sa dugang.', streak_days: '{n} ka adlaw nga sunod-sunod' }
  };
