...
(function(){
  ...
  ,sv:{pm_title:"Fått anteckningar av en vän?",pm_hint:"Lägg till en .jwshare.json som någon skickat dig — dess anteckningar läggs till i den här sammanslagningen.",pm_choose:"Välj delad fil",pm_loaded:"{n} delad(e) anteckning(ar) läggs till i den här sammanslagningen.",pm_remove:"Ta bort",tag_label:"Tagg för importerade anteckningar",pm_safe:"Tillagda som nya anteckningar — dina egna anteckningar ersätts aldrig.",ov_q:"{n} överstrykning(ar) hamnar på verser du redan strukit över. Hur ska vi lägga till dem?",ov_layer:"Lägg till som ett separat lager",ov_note:"Importera endast anteckning",cat_all:"Alla",cat_hl:"Överstrykningar",cat_note:"Anteckningar",conf_intro:"Dessa anteckningar är på verser du redan strukit över:",imp_title:"Tillagt i din sammanslagning",more_hint:"+{n} till — använd filtren ovan för att begränsa",preview:"Förhandsgranska",prev_title:"Delade anteckningar",close:"Stäng",dl:"Ladda ner",adding:"Lägger till delade anteckningar…",added:"{n} anteckning(ar) tillagda från en vän — tryck på Ladda ner för den uppdaterade filen.",invalid:"Den filen är inte en JW Sync-delningsfil.",shared_tag:"Delad"},ceb:{pm_title:'May mga nota gikan sa higala?',pm_hint:'Magdugang ug .jwshare.json nga gipadala kanimo — ang mga nota niini iduganon sa merge.',pm_choose:'Pilia ang file',pm_loaded:'{n} ka gipaambit nga nota ang iduganon sa merge.',pm_remove:'Tangtangon',tag_label:'Tag para sa mga na-import nga nota',pm_safe:'Gidugang isip mga bag-ong nota — dili gayud mapulihan ang imong mga nota.',ov_q:'{n} ka highlight ang naa sa mga bersikulo nga na-highlight mo na. Unsaon pagidugang?',ov_layer:'Idugang isip lain-laing layer',ov_note:'Ang nota lamang ang i-import',cat_all:'Tanan',cat_hl:'Mga highlight',cat_note:'Mga nota',conf_intro:'Kining mga nota naa sa mga bersikulo nga na-highlight mo na:',imp_title:'Gidugang sa imong merge',more_hint:'+{n} pa — gamiton ang mga filter',preview:'I-preview',prev_title:'Gipaambit nga mga nota',close:'Isira',dl:'I-download',adding:'Gidugang ang mga gipaambit nga nota…',added:'{n} ka nota gikan sa higala ang gidugang — i-tap ang Download para sa gi-update nga file.',invalid:'Dili kini JW Sync share file.',shared_tag:'Shared'},id:{pm_title:"Dapat catatan dari teman?",pm_hint:"Tambahkan berkas .jwshare.json yang dikirim seseorang — catatannya akan ditambahkan ke penggabungan ini.",pm_choose:"Pilih berkas berbagi",pm_loaded:"{n} catatan berbagi akan ditambahkan ke penggabungan ini.",pm_remove:"Hapus",tag_label:"Label untuk catatan yang diimpor",pm_safe:"Ditambahkan sebagai catatan baru — catatan Anda sendiri tidak pernah diganti.",ov_q:"{n} sorotan jatuh pada ayat yang sudah Anda soroti. Bagaimana sebaiknya kami menambahkannya?",ov_layer:"Tambahkan sebagai lapisan terpisah",ov_note:"Impor catatannya saja",cat_all:"Semua",cat_hl:"Sorotan",cat_note:"Catatan",conf_intro:"Catatan berikut ada pada ayat yang sudah Anda soroti:",imp_title:"Ditambahkan ke penggabungan Anda",more_hint:"+{n} lagi — gunakan saringan di atas untuk mempersempit",preview:"Pratinjau",prev_title:"Catatan berbagi",close:"Tutup",dl:"Unduh",adding:"Menambahkan catatan berbagi…",added:"{n} catatan ditambahkan dari seorang teman — ketuk Unduh untuk berkas terbarunya.",invalid:"Berkas itu bukan berkas berbagi JW Sync.",shared_tag:"Dibagikan"},hi:{pm_title:"किसी दोस्त से नोट मिले हैं?",pm_hint:"किसी की भेजी .jwshare.json फ़ाइल जोड़ें — उसके नोट इस मर्ज में शामिल हो जाएँगे।",pm_choose:"साझा फ़ाइल चुनें",pm_loaded:"{n} साझा किए गए नोट इस मर्ज में जोड़े जाएँगे।",pm_remove:"हटाएँ",tag_label:"आयात किए नोटों के लिए टैग",pm_safe:"नए नोट के रूप में जोड़े जाते हैं — आपके अपने नोट कभी नहीं बदले जाते।",ov_q:"{n} हाइलाइट उन आयतों पर पड़ते हैं जिन्हें आप पहले ही हाइलाइट कर चुके हैं। इन्हें कैसे जोड़ें?",ov_layer:"अलग परत के रूप में जोड़ें",ov_note:"सिर्फ़ नोट आयात करें",cat_all:"सभी",cat_hl:"हाइलाइट",cat_note:"नोट",conf_intro:"ये नोट उन आयतों पर हैं जिन्हें आप पहले ही हाइलाइट कर चुके हैं:",imp_title:"आपके मर्ज में जोड़ा गया",more_hint:"+{n} और — ऊपर के फ़िल्टर से दायरा घटाएँ",preview:"पूर्वावलोकन",prev_title:"साझा किए गए नोट",close:"बंद करें",dl:"डाउनलोड",adding:"साझा किए गए नोट जोड़े जा रहे हैं…",added:"किसी दोस्त से {n} नोट जोड़े गए — अपडेट की गई फ़ाइल के लिए डाउनलोड दबाएँ।",invalid:"यह फ़ाइल JW Sync की साझा फ़ाइल नहीं है।",shared_tag:"साझा किया गया"},hu:{pm_title:"Kaptál jegyzeteket egy barátodtól?",pm_hint:"Adj hozzá egy neked küldött .jwshare.json fájlt — a benne lévő jegyzetek bekerülnek ebbe az egyesítésbe.",pm_choose:"Megosztott fájl kiválasztása",pm_loaded:"{n} megosztott jegyzet kerül bele ebbe az egyesítésbe.",pm_remove:"Eltávolítás",tag_label:"Címke az importált jegyzetekhez",pm_safe:"Új jegyzetként kerülnek be — a saját jegyzeteidet semmi nem írja felül.",ov_q:"{n} kiemelés olyan versekre esik, amelyeket már kiemeltél. Hogyan adjuk hozzá őket?",ov_layer:"Külön rétegként add hozzá",ov_note:"Csak a jegyzetet importáld",cat_all:"Mind",cat_hl:"Kiemelések",cat_note:"Jegyzetek",conf_intro:"Ezek a jegyzetek olyan verseknél vannak, amelyeket már kiemeltél:",imp_title:"Hozzáadva az egyesítésedhez",more_hint:"+{n} további — szűkíts a fenti szűrőkkel",preview:"Előnézet",prev_title:"Megosztott jegyzetek",close:"Bezárás",dl:"Letöltés",adding:"Megosztott jegyzetek hozzáadása…",added:"{n} jegyzet hozzáadva egy barátodtól — koppints a Letöltésre a frissített fájlért.",invalid:"Ez a fájl nem JW Sync megosztási fájl.",shared_tag:"Megosztott"},vi:{pm_title:"Nhận được ghi chú từ một người bạn?",pm_hint:"Thêm tập tin .jwshare.json ai đó gửi cho bạn — các ghi chú trong đó sẽ được thêm vào lần hợp nhất này.",pm_choose:"Chọn tập tin chia sẻ",pm_loaded:"{n} ghi chú được chia sẻ sẽ được thêm vào lần hợp nhất này.",pm_remove:"Bỏ",tag_label:"Thẻ cho ghi chú nhập vào",pm_safe:"Được thêm dưới dạng ghi chú mới — ghi chú của bạn không bao giờ bị thay thế.",ov_q:"{n} phần tô màu rơi vào những câu bạn đã tô màu. Bạn muốn thêm chúng thế nào?",ov_layer:"Thêm thành một lớp riêng",ov_note:"Chỉ nhập ghi chú",cat_all:"Tất cả",cat_hl:"Phần tô màu",cat_note:"Ghi chú",conf_intro:"Những ghi chú này nằm ở các câu bạn đã tô màu:",imp_title:"Đã thêm vào bản hợp nhất",more_hint:"+{n} nữa — dùng bộ lọc ở trên để thu hẹp",preview:"Xem trước",prev_title:"Ghi chú được chia sẻ",close:"Đóng",dl:"Tải về",adding:"Đang thêm ghi chú được chia sẻ…",added:"Đã thêm {n} ghi chú từ một người bạn — nhấn Tải về để lấy tập tin đã cập nhật.",invalid:"Tập tin đó không phải là tập tin chia sẻ của JW Sync.",shared_tag:"Được chia sẻ"},"yue-Hant":{pm_title:"收到朋友寄嚟嘅筆記？",pm_hint:"加入人哋寄畀你嘅 .jwshare.json 檔案——入面嘅筆記會加落今次合併。",pm_choose:"揀分享檔案",pm_loaded:"會有 {n} 條分享嘅筆記加落今次合併。",pm_remove:"移除",tag_label:"匯入筆記嘅標籤",pm_safe:"會當做新筆記加入——你自己嘅筆記永遠唔會畀人取代。",ov_q:"有 {n} 處標註落喺你已經標註過嘅經文上。應該點樣加？",ov_layer:"當做獨立圖層加入",ov_note:"淨係匯入筆記",cat_all:"全部",cat_hl:"標註",cat_note:"筆記",conf_intro:"呢啲筆記喺你已經標註過嘅經文上：",imp_title:"已加落你嘅合併",more_hint:"另外仲有 {n} 條——用上面嘅篩選收窄範圍",preview:"預覽",prev_title:"分享嘅筆記",close:"閂咗佢",dl:"下載",adding:"加緊分享嘅筆記……",added:"由朋友嗰度加咗 {n} 條筆記——撳「下載」攞更新咗嘅檔案。",invalid:"呢個檔案唔係 JW Sync 嘅分享檔案。",shared_tag:"已分享"},"zh-Hant":{pm_title:"收到朋友發來的筆記了嗎？",pm_hint:"新增別人發給你的 .jwshare.json 檔案——其中的筆記會被加入這次合併。",pm_choose:"選擇分享檔案",pm_loaded:"將有 {n} 條分享的筆記加入這次合併。",pm_remove:"移除",tag_label:"匯入筆記的標籤",pm_safe:"會作為新筆記新增——你自己的筆記絕不會被替換。",ov_q:"有 {n} 處標註落在你已經標註過的經文上。應該如何新增？",ov_layer:"作為獨立圖層新增",ov_note:"僅匯入筆記",cat_all:"全部",cat_hl:"標註",cat_note:"筆記",conf_intro:"這些筆記位於你已經標註過的經文上：",imp_title:"已加入你的合併",more_hint:"另有 {n} 條——請使用上方的篩選器縮小範圍",preview:"預覽",prev_title:"分享的筆記",close:"關閉",dl:"下載",adding:"正在新增分享的筆記……",added:"已從朋友那裡新增 {n} 條筆記——點擊「下載」獲取更新後的檔案。",invalid:"這個檔案不是 JW Sync 的分享檔案。",shared_tag:"已分享"},"zh-Hans":{pm_title:"收到朋友发来的笔记了吗？",pm_hint:"添加别人发给你的 .jwshare.json 文件——其中的笔记会被加入这次合并。",pm_choose:"选择分享文件",pm_loaded:"将有 {n} 条分享的笔记加入这次合并。",pm_remove:"移除",tag_label:"导入笔记的标签",pm_safe:"会作为新笔记添加——你自己的笔记绝不会被替换。",ov_q:"有 {n} 处标注落在你已经标注过的经文上。应该如何添加？",ov_layer:"作为独立图层添加",ov_note:"仅导入笔记",cat_all:"全部",cat_hl:"标注",cat_note:"笔记",conf_intro:"这些笔记位于你已经标注过的经文上：",imp_title:"已加入你的合并",more_hint:"另有 {n} 条——请使用上方的筛选器缩小范围",preview:"预览",prev_title:"分享的笔记",close:"关闭",dl:"下载",adding:"正在添加分享的笔记……",added:"已从朋友那里添加 {n} 条笔记——点击「下载」获取更新后的文件。",invalid:"这个文件不是 JW Sync 的分享文件。",shared_tag:"已分享"},pl:{pm_title:"Dostałeś notatki od znajomego?",pm_hint:"Dodaj plik .jwshare.json, który ktoś Ci przysłał — jego notatki zostaną dodane do tego scalania.",pm_choose:"Wybierz udostępniony plik",pm_loaded:"{n} udostępnionych notatek zostanie dodanych do tego scalania.",pm_remove:"Usuń",tag_label:"Etykieta dla zaimportowanych notatek",pm_safe:"Dodawane jako nowe notatki — Twoje własne notatki nigdy nie są zastępowane.",ov_q:"{n} wyróżnień trafia na wersety, które już wyróżniłeś. Jak mamy je dodać?",ov_layer:"Dodaj jako osobną warstwę",ov_note:"Zaimportuj tylko notatkę",cat_all:"Wszystkie",cat_hl:"Wyróżnienia",cat_note:"Notatki",conf_intro:"Te notatki dotyczą wersetów, które już wyróżniłeś:",imp_title:"Dodano do Twojego scalania",more_hint:"Jeszcze +{n} — użyj filtrów powyżej, aby zawęzić",preview:"Podgląd",prev_title:"Udostępnione notatki",close:"Zamknij",dl:"Pobierz",adding:"Dodawanie udostępnionych notatek…",added:"Dodano {n} notatek od znajomego — dotknij Pobierz, aby otrzymać zaktualizowany plik.",invalid:"Ten plik nie jest plikiem udostępniania JW Sync.",shared_tag:"Udostępnione"},uk:{pm_title:"Отримали нотатки від друга?",pm_hint:"Додайте файл .jwshare.json, який вам надіслали, — його нотатки буде додано до цього об'єднання.",pm_choose:"Вибрати спільний файл",pm_loaded:"{n} спільних нотаток буде додано до цього об'єднання.",pm_remove:"Вилучити",tag_label:"Тег для імпортованих нотаток",pm_safe:"Додаються як нові нотатки — ваші власні нотатки ніколи не замінюються.",ov_q:"{n} виділень припадають на вірші, які ви вже виділили. Як їх додати?",ov_layer:"Додати окремим шаром",ov_note:"Імпортувати лише нотатку",cat_all:"Усі",cat_hl:"Виділення",cat_note:"Нотатки",conf_intro:"Ці нотатки стосуються віршів, які ви вже виділили:",imp_title:"Додано до вашого об'єднання",more_hint:"Ще +{n} — скористайтеся фільтрами вгорі, щоб звузити пошук",preview:"Перегляд",prev_title:"Спільні нотатки",close:"Закрити",dl:"Завантажити",adding:"Додаємо спільні нотатки…",added:"{n} нотаток додано від друга — натисніть «Завантажити», щоб отримати оновлений файл.",invalid:"Цей файл не є файлом спільного доступу JW Sync.",shared_tag:"Спільні"},he:{pm_title:"קיבלתם הערות מחבר?",pm_hint:"הוסיפו קובץ ‎.jwshare.json שמישהו שלח לכם — ההערות שבו יתווספו למיזוג הזה.",pm_choose:"בחירת קובץ משותף",pm_loaded:"{n} הערות משותפות יתווספו למיזוג הזה.",pm_remove:"הסרה",tag_label:"תווית להערות המיובאות",pm_safe:"נוספות כהערות חדשות — ההערות שלכם לעולם לא מוחלפות.",ov_q:"{n} הדגשות נופלות על פסוקים שכבר הדגשתם. איך להוסיף אותן?",ov_layer:"הוספה כשכבה נפרדת",ov_note:"ייבוא ההערה בלבד",cat_all:"הכול",cat_hl:"הדגשות",cat_note:"הערות",conf_intro:"ההערות האלה נמצאות על פסוקים שכבר הדגשתם:",imp_title:"נוספו למיזוג שלכם",more_hint:"+{n} נוספות — השתמשו במסננים שלמעלה כדי לצמצם",preview:"תצוגה מקדימה",prev_title:"הערות משותפות",close:"סגירה",dl:"הורדה",adding:"מוסיף הערות משותפות…",added:"{n} הערות נוספו מחבר — הקישו על הורדה לקבלת הקובץ המעודכן.",invalid:"הקובץ הזה אינו קובץ שיתוף של JW Sync.",shared_tag:"משותף"},ar:{pm_title:"وصلتك ملاحظات من صديق؟",pm_hint:"أضف ملف ‎.jwshare.json‎ أرسله إليك أحدهم — ستُضاف ملاحظاته إلى هذا الدمج.",pm_choose:"اختر الملف المُشارَك",pm_loaded:"ستُضاف {n} ملاحظة مُشارَكة إلى هذا الدمج.",pm_remove:"إزالة",tag_label:"وسم للملاحظات المستوردة",pm_safe:"تُضاف كملاحظات جديدة — ملاحظاتك الخاصة لا تُستبدل أبدًا.",ov_q:"{n} تظليل يقع على آيات ظلّلتها من قبل. كيف تريد إضافتها؟",ov_layer:"أضفها كطبقة مستقلة",ov_note:"استورد الملاحظة فقط",cat_all:"الكل",cat_hl:"التظليلات",cat_note:"الملاحظات",conf_intro:"هذه الملاحظات على آيات ظلّلتها من قبل:",imp_title:"أُضيفت إلى الدمج",more_hint:"+{n} إضافية — استخدم عوامل التصفية أعلاه للتضييق",preview:"معاينة",prev_title:"الملاحظات المُشارَكة",close:"إغلاق",dl:"تنزيل",adding:"جارٍ إضافة الملاحظات المُشارَكة…",added:"أُضيفت {n} ملاحظة من صديق — اضغط تنزيل للحصول على الملف المحدَّث.",invalid:"هذا الملف ليس ملف مشاركة من JW Sync.",shared_tag:"مُشارَكة"}};
