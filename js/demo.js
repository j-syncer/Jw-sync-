...
(function () {
  ...
  ,sv:{banner_title:"Demoläge",banner_body:"Två exempelsäkerhetskopior är inlästa. Klicka på <strong>Förhandsvisa sammanslagning</strong> för att se hur de kombineras, och sedan <strong>Bekräfta sammanslagning</strong> för att ladda ner resultatet.",banner_dismiss:"Avsluta demo",err_generic:"Kunde inte starta demon — kontrollera din anslutning och försök igen.",err_inject:"Kunde inte läsa in exempelfilerna i appen. Uppdatera sidan och försök igen.",overwrite_warn:"Att starta demon ersätter de filer du har inlästa just nu. Fortsätta?"},ceb:{banner_title:'Demo mode',banner_body:'Naka-load ang duha ka sample backup. I-click ang <strong>Preview Merge</strong> unya <strong>Confirm Merge</strong> aron i-download ang resulta.',banner_dismiss:'Isira ang demo',err_generic:'Dili masimulan ang demo. Pakisusi ang imong koneksyon ug sulayi pag-usab.',err_inject:'Dili na-load ang mga sample file. Palihug i-refresh ang pahina.',overwrite_warn:'Mapulihan sa demo ang mga naka-load na nga file. Magpadayon?'},el:{banner_title:"Λειτουργία επίδειξης",banner_body:"Έχουν φορτωθεί δύο δείγματα αντιγράφων ασφαλείας. Πατήστε <strong>Προεπισκόπηση συγχώνευσης</strong> για να δείτε πώς συνδυάζονται και έπειτα <strong>Επιβεβαίωση συγχώνευσης</strong> για να κατεβάσετε το αποτέλεσμα.",banner_dismiss:"Κλείσιμο επίδειξης",err_generic:"Δεν ήταν δυνατή η έναρξη της επίδειξης — ελέγξτε τη σύνδεσή σας και δοκιμάστε ξανά.",err_inject:"Δεν ήταν δυνατή η φόρτωση των δειγμάτων στην εφαρμογή. Ανανεώστε τη σελίδα και δοκιμάστε ξανά.",overwrite_warn:"Η έναρξη της επίδειξης θα αντικαταστήσει τα αρχεία που έχετε φορτώσει. Να συνεχίσω;"},sw:{banner_title:"Hali ya onyesho",banner_body:"Nakala rudufu mbili za mfano zimepakiwa. Bofya <strong>Hakiki Muunganisho</strong> uone jinsi zinavyoungana, kisha <strong>Thibitisha Muunganisho</strong> ili kupakua matokeo.",banner_dismiss:"Ondoa onyesho",err_generic:"Haikuwezekana kuanzisha onyesho — tafadhali angalia muunganisho wako wa intaneti kisha ujaribu tena.",err_inject:"Haikuwezekana kupakia mafaili ya mfano kwenye programu. Tafadhali onyesha upya ukurasa kisha ujaribu tena.",overwrite_warn:"Kuanzisha onyesho kutabadilisha mafaili uliyopakia sasa. Uendelee?"},nl:{banner_title:"Demomodus",banner_body:"Er zijn twee voorbeeldback-ups geladen. Klik op <strong>Samenvoeging bekijken</strong> om te zien hoe ze worden gecombineerd, en daarna op <strong>Samenvoegen bevestigen</strong> om het resultaat te downloaden.",banner_dismiss:"Demo sluiten",err_generic:"De demo kon niet worden gestart — controleer je verbinding en probeer het opnieuw.",err_inject:"De voorbeeldbestanden konden niet in de app worden geladen. Ververs de pagina en probeer het opnieuw.",overwrite_warn:"Als je de demo start, worden de bestanden die je nu geladen hebt vervangen. Doorgaan?"},ro:{banner_title:"Mod demonstrativ",banner_body:"Sunt încărcate două copii de rezervă de probă. Apasă pe <strong>Previzualizează îmbinarea</strong> ca să vezi cum se combină, apoi pe <strong>Confirmă îmbinarea</strong> ca să descarci rezultatul.",banner_dismiss:"Închide demonstrația",err_generic:"Demonstrația nu a putut porni — verifică-ți conexiunea și încearcă din nou.",err_inject:"Fișierele de probă nu au putut fi încărcate în aplicație. Reîmprospătează pagina și încearcă din nou.",overwrite_warn:"Pornirea demonstrației va înlocui fișierele încărcate în acest moment. Continui?"},id:{banner_title:"Mode demo",banner_body:"Dua contoh cadangan sudah dimuat. Klik <strong>Pratinjau Gabungan</strong> untuk melihat hasil penggabungannya, lalu <strong>Konfirmasi Gabungan</strong> untuk mengunduh hasilnya.",banner_dismiss:"Tutup demo",err_generic:"Demo tidak dapat dimulai — silakan periksa koneksi Anda lalu coba lagi.",err_inject:"Contoh berkas tidak dapat dimuat ke dalam aplikasi. Silakan muat ulang halaman lalu coba lagi.",overwrite_warn:"Memulai demo akan mengganti berkas yang sedang dimuat. Lanjutkan?"},hi:{banner_title:"डेमो मोड",banner_body:"दो नमूना बैकअप लोड किए गए हैं। यह देखने के लिए कि वे कैसे जुड़ते हैं, <strong>मर्ज का पूर्वावलोकन</strong> पर क्लिक करें, फिर नतीजा डाउनलोड करने के लिए <strong>मर्ज की पुष्टि करें</strong> दबाएँ।",banner_dismiss:"डेमो बंद करें",err_generic:"डेमो शुरू नहीं हो सका — कृपया अपना कनेक्शन जाँचें और फिर कोशिश करें।",err_inject:"नमूना फ़ाइलें ऐप में लोड नहीं हो सकीं। कृपया पेज रिफ़्रेश करके फिर कोशिश करें।",overwrite_warn:"डेमो शुरू करने पर अभी लोड की गई आपकी फ़ाइलें हट जाएँगी। जारी रखें?"},hu:{banner_title:"Bemutató mód",banner_body:"Két mintamentés van betöltve. Kattints az <strong>Egyesítés előnézete</strong> gombra, hogy lásd, hogyan állnak össze, majd az <strong>Egyesítés megerősítése</strong> gombra az eredmény letöltéséhez.",banner_dismiss:"Bemutató bezárása",err_generic:"Nem sikerült elindítani a bemutatót — ellenőrizd a kapcsolatot, és próbáld újra.",err_inject:"Nem sikerült betölteni a mintafájlokat az alkalmazásba. Frissítsd az oldalt, és próbáld újra.",overwrite_warn:"A bemutató indítása lecseréli a jelenleg betöltött fájljaidat. Folytatod?"},vi:{banner_title:"Chế độ dùng thử",banner_body:"Đã tải hai bản sao lưu mẫu. Nhấn <strong>Xem trước khi hợp nhất</strong> để thấy chúng kết hợp ra sao, rồi nhấn <strong>Xác nhận hợp nhất</strong> để tải kết quả về.",banner_dismiss:"Đóng bản dùng thử",err_generic:"Không thể bắt đầu bản dùng thử — vui lòng kiểm tra kết nối và thử lại.",err_inject:"Không thể tải các tập tin mẫu vào ứng dụng. Vui lòng tải lại trang và thử lại.",overwrite_warn:"Bắt đầu bản dùng thử sẽ thay thế các tập tin bạn đang tải. Tiếp tục chứ?"},"yue-Hant":{banner_title:"示範模式",banner_body:"已經載入咗兩個範例備份。撳<strong>預覽合併</strong>睇吓佢哋點樣合埋，然後撳<strong>確認合併</strong>就可以下載結果。",banner_dismiss:"關閉示範",err_generic:"起動唔到示範——請檢查吓網絡連線再試過。",err_inject:"載入唔到範例檔案。請重新整理版面再試過。",overwrite_warn:"起動示範會取代而家載入咗嘅檔案。要繼續嗎？"},"zh-Hant":{banner_title:"演示模式",banner_body:"已載入兩個示例備份。點擊<strong>預覽合併</strong>檢視它們如何合併，然後點擊<strong>確認合併</strong>下載結果。",banner_dismiss:"關閉演示",err_generic:"無法啟動演示——請檢查網路連線後重試。",err_inject:"無法將示例檔案載入到應用中。請重新整理頁面後重試。",overwrite_warn:"啟動演示會替換當前已載入的檔案。要繼續嗎？"},"zh-Hans":{banner_title:"演示模式",banner_body:"已加载两个示例备份。点击<strong>预览合并</strong>查看它们如何合并，然后点击<strong>确认合并</strong>下载结果。",banner_dismiss:"关闭演示",err_generic:"无法启动演示——请检查网络连接后重试。",err_inject:"无法将示例文件加载到应用中。请刷新页面后重试。",overwrite_warn:"启动演示会替换当前已加载的文件。要继续吗？"},pl:{banner_title:"Tryb demonstracyjny",banner_body:"Wczytano dwie przykładowe kopie zapasowe. Kliknij <strong>Podgląd scalania</strong>, aby zobaczyć, jak zostaną połączone, a następnie <strong>Potwierdź scalanie</strong>, aby pobrać wynik.",banner_dismiss:"Zamknij demonstrację",err_generic:"Nie udało się uruchomić demonstracji — sprawdź połączenie i spróbuj ponownie.",err_inject:"Nie udało się wczytać przykładowych plików do aplikacji. Odśwież stronę i spróbuj ponownie.",overwrite_warn:"Uruchomienie demonstracji zastąpi obecnie wczytane pliki. Kontynuować?"},uk:{banner_title:"Демонстраційний режим",banner_body:"Завантажено дві зразкові резервні копії. Натисніть <strong>Попередній перегляд об'єднання</strong>, щоб побачити, як вони поєднаються, а тоді <strong>Підтвердити об'єднання</strong>, щоб завантажити результат.",banner_dismiss:"Закрити демонстрацію",err_generic:"Не вдалося запустити демонстрацію — перевірте з'єднання і спробуйте ще раз.",err_inject:"Не вдалося завантажити зразкові файли в програму. Оновіть сторінку і спробуйте ще раз.",overwrite_warn:"Запуск демонстрації замінить файли, які зараз завантажені. Продовжити?"},he:{banner_title:"מצב הדגמה",banner_body:"נטענו שני גיבויים לדוגמה. לחצו על <strong>תצוגה מקדימה של המיזוג</strong> כדי לראות איך הם משתלבים, ואז על <strong>אישור המיזוג</strong> כדי להוריד את התוצאה.",banner_dismiss:"סגירת ההדגמה",err_generic:"לא הצלחנו להפעיל את ההדגמה — בדקו את החיבור ונסו שוב.",err_inject:"לא הצלחנו לטעון את קובצי הדוגמה ליישום. רעננו את הדף ונסו שוב.",overwrite_warn:"הפעלת ההדגמה תחליף את הקבצים שטעונים כעת. להמשיך?"},ar:{banner_title:"الوضع التجريبي",banner_body:"تم تحميل نسختين احتياطيتين تجريبيتين. اضغط <strong>معاينة الدمج</strong> لترى كيف تندمجان، ثم <strong>تأكيد الدمج</strong> لتنزيل النتيجة.",banner_dismiss:"إنهاء العرض التجريبي",err_generic:"تعذّر بدء العرض التجريبي — تحقّق من اتصالك وحاول مرة أخرى.",err_inject:"تعذّر تحميل الملفات التجريبية في التطبيق. أعد تحديث الصفحة وحاول مرة أخرى.",overwrite_warn:"بدء العرض التجريبي سيستبدل الملفات المحمّلة حاليًا. هل تريد المتابعة؟"}};
  function lang() {
