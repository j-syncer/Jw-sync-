...
(function(){
  ...
  var W={
   ...
   ceb:{close:'Sirad-i',badge:'100% pribado — ang imong mga file dili mobiya niini nga device',how:'Giunsa kini paglihok',title:'Hiusaha ang imong library sa 3 ka lakang',sub:'Tanan mahitabo sa imong device. Ang imong mga file dili gyud ma-upload.',s1t:'I-export ang imong mga backup',s1d:'Sa JW Library, paghimo og backup sa matag device ug i-save ang mga .jwlibrary file.',s1btn:'Ipakita kung unsaon',s2t:'Idugang ug hiusahon',s2d:'Idugang ang imong nag-unang backup, dayon ang uban, ug i-tap ang Hiusahon.',s3t:'I-restore',s3d:'I-download ang gihiusa nga file ug i-restore kini sa JW Library.',s3btn:'Giya sa pag-restore',start:'Sugdi',skip:'Laktawi',tab1:'Paghiusa',tab2:'Uban pang himan',t_intro:'Ang JW Sync adunay pipila pa ka himan — mao kini ang gibuhat sa matag usa:',exp_d:'Ablihi ang bisan unsang backup aron pangitaon, basahon, i-edit ug i-tag ang imong mga nota, usbon ang kolor sa highlight, ug pangitaon ang mga nota pinaagi sa kahulogan gamit ang Pangutana sa imong Library — dayon i-save sa .jwlibrary file.',stat_d:'Pag-load og backup aron makita ang imong mga total, streak ug uso sa pagtuon, lakip ang Awards nga tab nga adunay mga medalya nga imong makuha sa pag-abot sa mga milestone.',shr_d:'Pagpadala og piniling mga nota sa imong higala isip gamay nga share file, o idugang ang mga nota nga gipadala kanimo — nga dili hiusahon ang tibuok backup.',open:'Ablihi'},pl:{close:"Zamknij",badge:"100% prywatnie — Twoje pliki nie opuszczają tego urządzenia",how:"Jak to działa",title:"Scal swoją bibliotekę w 3 krokach",sub:"Wszystko dzieje się na Twoim urządzeniu. Twoje pliki nigdy nie są wysyłane na serwer.",s1t:"Wyeksportuj swoje kopie zapasowe",s1d:"W JW Library na każdym urządzeniu utwórz kopię zapasową i zapisz pliki .jwlibrary.",s1btn:"Pokaż mi jak",s2t:"Dodaj i scal",s2d:"Dodaj swoją główną kopię, potem pozostałe i dotknij Scal.",s3t:"Przywracanie",s3d:"Pobierz scalony plik i przywróć go w JW Library.",s3btn:"Poradnik przywracania",start:"Zaczynajmy",skip:"Pomiń",tab1:"Scalanie",tab2:"Inne narzędzia",t_intro:"JW Sync ma jeszcze kilka narzędzi — oto co robi każde z nich:",exp_d:"Otwórz dowolną kopię zapasową, aby przeszukiwać, czytać, edytować i etykietować swoje notatki, zmieniać kolory wyróżnień i znajdować notatki według znaczenia dzięki funkcji „Zapytaj swoją bibliotekę” — a potem zapisz wszystko z powrotem do pliku .jwlibrary.",stat_d:"Wczytaj kopię zapasową, aby zobaczyć podsumowania studium, passy i trendy, a także zakładkę osiągnięć z medalami zdobywanymi za kolejne etapy nauki.",shr_d:"Wyślij znajomemu wybrane notatki w małym pliku albo dodaj notatki, które on przysłał Tobie — bez scalania całych kopii zapasowych.",open:"Otwórz"},uk:{close:"Закрити",badge:"100% приватно — ваші файли не залишають цей пристрій",how:"Як це працює",title:"Об'єднайте свою бібліотеку за 3 кроки",sub:"Усе відбувається на вашому пристрої. Ваші файли ніколи не надсилаються на сервер.",s1t:"Експортуйте свої резервні копії",s1d:"У JW Library на кожному пристрої створіть резервну копію і збережіть файли .jwlibrary.",s1btn:"Покажіть як",s2t:"Додати й об'єднати",s2d:"Додайте свою основну копію, тоді решту, і натисніть «Об'єднати».",s3t:"Відновлення",s3d:"Завантажте об'єднаний файл і відновіть його в JW Library.",s3btn:"Посібник з відновлення",start:"Почати",skip:"Пропустити",tab1:"Об'єднання",tab2:"Інші інструменти",t_intro:"JW Sync має ще кілька інструментів — ось що робить кожен з них:",exp_d:"Відкрийте будь-яку резервну копію, щоб шукати, читати, редагувати й позначати тегами свої нотатки, змінювати кольори виділень і знаходити нотатки за змістом за допомогою «Запитайте свою бібліотеку» — а тоді збережіть усе назад у файл .jwlibrary.",stat_d:"Завантажте резервну копію, щоб побачити підсумки вивчення, серії та тенденції, а також вкладку нагород з медалями, які ви здобуваєте за досягнення в навчанні.",shr_d:"Надішліть другові вибрані нотатки невеликим файлом або додайте нотатки, які надіслав вам друг, — без об'єднання цілих резервних копій.",open:"Відкрити"},he:{close:"סגירה",badge:"‏100% פרטי — הקבצים שלכם לא עוזבים את המכשיר הזה",how:"איך זה עובד",title:"מזגו את הספרייה שלכם ב-3 שלבים",sub:"הכול קורה על המכשיר שלכם. הקבצים שלכם לעולם לא מועלים לשרת.",s1t:"ייצאו את הגיבויים שלכם",s1d:"ב-JW Library בכל מכשיר, צרו גיבוי ושמרו את קובצי ‎.jwlibrary.",s1btn:"הראו לי איך",s2t:"הוספה ומיזוג",s2d:"הוסיפו את הגיבוי הראשי שלכם, אחר כך את השאר, והקישו על מיזוג.",s3t:"שחזור",s3d:"הורידו את הקובץ הממוזג ושחזרו אותו ב-JW Library.",s3btn:"מדריך השחזור",start:"בואו נתחיל",skip:"דילוג",tab1:"מיזוג",tab2:"כלים נוספים",t_intro:"ל-JW Sync יש עוד כמה כלים — הנה מה שכל אחד מהם עושה:",exp_d:"פתחו כל גיבוי כדי לחפש, לקרוא, לערוך ולתייג את ההערות שלכם, לשנות צבעי הדגשה ולמצוא הערות לפי משמעות בעזרת \"שאלו את הספרייה\" — ואז לשמור חזרה לקובץ ‎.jwlibrary.",stat_d:"טענו גיבוי כדי לראות את סיכומי הלימוד, הרצפים והמגמות שלכם, וגם לשונית הישגים עם מדליות שאתם צוברים על עמידה באבני דרך בלימוד.",shr_d:"שלחו הערות נבחרות לחבר כקובץ שיתוף קטן, או הוסיפו הערות שחבר שלח לכם — בלי למזג גיבויים שלמים.",open:"פתיחה"},ar:{close:"إغلاق",badge:"خصوصية 100% — ملفاتك لا تغادر هذا الجهاز أبدًا",how:"طريقة العمل",title:"ادمج مكتبتك في 3 خطوات",sub:"كل شيء يجري على جهازك. ملفاتك لا تُرفع أبدًا.",s1t:"صدّر نسخك الاحتياطية",s1d:"من JW Library على كل جهاز، أنشئ نسخة احتياطية واحفظ ملفات ‎.jwlibrary‎.",s1btn:"أرِني الطريقة",s2t:"أضف وادمج",s2d:"أضف نسختك الاحتياطية الرئيسية، ثم البقية، واضغط دمج.",s3t:"استعادة",s3d:"نزّل الملف المدمج واستعده في JW Library.",s3btn:"دليل الاستعادة",start:"لنبدأ",skip:"تخطٍّ",tab1:"الدمج",tab2:"أدوات أخرى",t_intro:"يضم JW Sync أدوات أخرى — إليك ما تفعله كل منها:",exp_d:"افتح أي نسخة احتياطية للبحث في ملاحظاتك وقراءتها وتحريرها ووسمها، وتغيير ألوان التظليل، والعثور على الملاحظات بالمعنى عبر «اسأل مكتبتك» — ثم احفظها في ملف ‎.jwlibrary‎.",stat_d:"حمّل نسخة احتياطية لترى إجماليات درسك وسلاسل مواظبتك واتجاهاتك، إضافة إلى تبويب الأوسمة بميداليات تكسبها عند بلوغ محطات الدرس.",shr_d:"أرسل ملاحظات مختارة إلى صديق كملف مشاركة صغير، أو أضف ملاحظات أرسلها إليك صديق — دون دمج نسخ احتياطية كاملة.",open:"افتح"}
  };
