...
(function () {
  ...
  ,sv:{close:"Stäng",cele_title:"Sammanslagning klar",cele_subtitle:"Du kombinerade dina säkerhetskopior till en enda enhetlig fil.",stat_notes:"anteckningar",stat_highlights:"överstrykningar",stat_bookmarks:"bokmärken",stat_tags:"taggar",cele_download:"Ladda ner sammanslagen säkerhetskopia",cele_redownload:"Ladda ner igen",cele_downloading:"Din fil laddas ner…",cele_browse:"Bläddra i det sammanslagna resultatet",cele_restore:"Återställ till JW Library",cele_demo_title:"Det var en demo med exempeldata",cele_demo_body:"Redo att testa med dina egna JW Library-säkerhetskopior?",cele_demo_cta:"Använd mina riktiga filer",donate_prompt:"Tycker du att JW Sync är användbar?",donate_cta:"Stöd utvecklingen",guide_title:"Så återställer du till JW Library",guide_tab_ios:"iPhone / iPad",guide_tab_android:"Android",guide_tab_other:"Övrigt / Dator",guide_warning:"Återställning ersätter anteckningarna som finns i JW Library just nu. Behåll den här sammanslagna säkerhetskopian som din originalkopia.",guide_done:"Uppfattat",guide_export_title:"Så exporterar du från JW Library",guide_mode_export:"Exportera säkerhetskopior",guide_mode_restore:"Återställ sammanslagen fil",cele_highlights:"Visa din statistik",cele_addshared:"Lägg till anteckningar en vän delat",perf_title:"Sammanslagningens prestanda",perf_prepare:"Förbered",perf_merge:"Slå ihop",perf_package:"Paketera",perf_tip_large:"Stort bibliotek — för snabbare sammanslagningar, kombinera färre filer åt gången eller använd extrahering per datumintervall.",cele_top_medals:"Dina bästa medaljer",cele_awards_btn:"Utforska utmärkelserna →"},ceb:{close:'Isira',cele_title:'Natapos ang merge!',cele_subtitle:'Gisagol mo ang imong mga backup ngadto sa usa ka pinag-isang file.',stat_notes:'mga nota',stat_highlights:'mga highlight',stat_bookmarks:'mga bookmark',stat_tags:'mga tag',cele_download:'I-download ang gisagol nga backup',cele_redownload:'I-download pag-usab',cele_downloading:'Gi-download na ang imong file…',cele_browse:'Tan-awon ang resulta sa merge',cele_restore:'I-restore sa JW Library',cele_demo_title:'Usa ka demo gamit ang sample data ang nahitabo',cele_demo_body:'Andam na nga sulayin gamit ang imong kaugalingong mga backup sa JW Library?',cele_demo_cta:'Gamita ang akong mga file',donate_prompt:'Nakatabang ba kanimo ang JW Sync?',donate_cta:'Suportahan ang pag-develop',guide_title:'Unsaon pag-restore sa JW Library',guide_tab_ios:'iPhone / iPad',guide_tab_android:'Android',guide_tab_other:'Uban / Desktop',guide_warning:'Mapulihan sa restore ang kasamtangan nga mga nota sa JW Library. Tipigan kining gisagol nga backup isip imong master copy.',guide_done:'Nasabtan',guide_export_title:'Unsaon pag-export gikan sa JW Library',guide_mode_export:'Mag-export ug backup',guide_mode_restore:'I-restore ang file',cele_highlights:'Tan-awa ang mga Stats',cele_addshared:'Idugang ang mga nota sa higala',perf_title:'Performance sa merge',perf_prepare:'Andam-anama',perf_merge:'Isagol',perf_package:'I-package',perf_tip_large:'Dako nga librarya — para sa mas paspas nga merge, magsagol ug mas gamay nga mga file sa usa ka higayon o gamiton ang date-range extraction.',cele_top_medals:'Imong pinakataas nga mga medalya',cele_awards_btn:'I-explore ang mga ganti →'},el:{close:"Κλείσιμο",cele_title:"Η συγχώνευση ολοκληρώθηκε",cele_subtitle:"Συνδυάσατε τα αντίγραφα ασφαλείας σας σε ένα ενιαίο αρχείο.",stat_notes:"σημειώσεις",stat_highlights:"επισημάνσεις",stat_bookmarks:"σελιδοδείκτες",stat_tags:"ετικέτες",cele_download:"Λήψη συγχωνευμένου αντιγράφου ασφαλείας",cele_redownload:"Λήψη ξανά",cele_downloading:"Το αρχείο σας κατεβαίνει…",cele_browse:"Περιήγηση στο συγχωνευμένο αποτέλεσμα",cele_restore:"Επαναφορά στο JW Library",cele_demo_title:"Αυτή ήταν μια επίδειξη με δείγμα δεδομένων",cele_demo_body:"Έτοιμοι να δοκιμάσετε με τα δικά σας αντίγραφα ασφαλείας του JW Library;",cele_demo_cta:"Χρήση των πραγματικών μου αρχείων",donate_prompt:"Σας φάνηκε χρήσιμο το JW Sync;",donate_cta:"Στηρίξτε την ανάπτυξη",guide_title:"Πώς να κάνετε επαναφορά στο JW Library",guide_tab_ios:"iPhone / iPad",guide_tab_android:"Android",guide_tab_other:"Άλλο / Υπολογιστής",guide_warning:"Η επαναφορά αντικαθιστά τις σημειώσεις που υπάρχουν αυτή τη στιγμή στο JW Library. Κρατήστε αυτό το συγχωνευμένο αντίγραφο ασφαλείας ως το κύριο αντίγραφό σας.",guide_done:"Το κατάλαβα",guide_export_title:"Πώς να κάνετε εξαγωγή από το JW Library",guide_mode_export:"Εξαγωγή αντιγράφων ασφαλείας",guide_mode_restore:"Επαναφορά συγχωνευμένου αρχείου",cele_highlights:"Δείτε τα στατιστικά σας",cele_addshared:"Προσθέστε σημειώσεις που μοιράστηκε ένας φίλος",perf_title:"Επιδόσεις συγχώνευσης",perf_prepare:"Προετοιμασία",perf_merge:"Συγχώνευση",perf_package:"Συσκευασία",perf_tip_large:"Μεγάλη βιβλιοθήκη — για ταχύτερες συγχωνεύσεις, συνδυάστε λιγότερα αρχεία κάθε φορά ή χρησιμοποιήστε εξαγωγή χρονικής περιόδου.",cele_top_medals:"Τα κορυφαία μετάλλιά σας",cele_awards_btn:"Εξερευνήστε τα βραβεία σας →"},sw:{close:"Funga",cele_title:"Muunganisho umekamilika",cele_subtitle:"Umeunganisha nakala zako rudufu kuwa faili moja lililoungana.",stat_notes:"madokezo",stat_highlights:"viangazio",stat_bookmarks:"alamisho",stat_tags:"lebo",cele_download:"Pakua nakala rudufu iliyounganishwa",cele_redownload:"Pakua tena",cele_downloading:"Faili lako linapakuliwa…",cele_browse:"Vinjari matokeo yaliyounganishwa",cele_restore:"Rejesha kwenye JW Library",cele_demo_title:"Hilo lilikuwa onyesho lenye data ya mfano",cele_demo_body:"Uko tayari kujaribu na nakala zako rudufu halisi za JW Library?",cele_demo_cta:"Tumia mafaili yangu halisi",donate_prompt:"Umeona JW Sync ni ya manufaa?",donate_cta:"Saidia uendelezaji",guide_title:"Jinsi ya kurejesha kwenye JW Library",guide_tab_ios:"iPhone / iPad",guide_tab_android:"Android",guide_tab_other:"Nyingine / Kompyuta",guide_warning:"Kurejesha hubadilisha madokezo yaliyomo sasa katika JW Library. Hifadhi nakala hii rudufu iliyounganishwa kuwa nakala yako kuu.",guide_done:"Nimeelewa",guide_export_title:"Jinsi ya kuhamisha kutoka JW Library",guide_mode_export:"Hamisha nakala rudufu",guide_mode_restore:"Rejesha faili lililounganishwa",cele_highlights:"Ona Takwimu Zako",cele_addshared:"Ongeza madokezo aliyoshiriki rafiki",perf_title:"Utendaji wa muunganisho",perf_prepare:"Kuandaa",perf_merge:"Kuunganisha",perf_package:"Kufunga",perf_tip_large:"Maktaba kubwa — ili kuunganisha haraka zaidi, unganisha mafaili machache kwa wakati mmoja au utumie uchopoaji wa kipindi cha tarehe.",cele_top_medals:"Medali zako bora",cele_awards_btn:"Chunguza Tuzo Zako →"},nl:{close:"Sluiten",cele_title:"Samenvoegen voltooid",cele_subtitle:"Je hebt je back-ups gecombineerd tot één samengevoegd bestand.",stat_notes:"aantekeningen",stat_highlights:"markeringen",stat_bookmarks:"bladwijzers",stat_tags:"labels",cele_download:"Samengevoegde back-up downloaden",cele_redownload:"Opnieuw downloaden",cele_downloading:"Je bestand wordt gedownload…",cele_browse:"Het samengevoegde resultaat bekijken",cele_restore:"Terugzetten in JW Library",cele_demo_title:"Dat was een demo met voorbeeldgegevens",cele_demo_body:"Klaar om het met je eigen JW Library-back-ups te proberen?",cele_demo_cta:"Mijn echte bestanden gebruiken",donate_prompt:"Vond je JW Sync nuttig?",donate_cta:"Steun de ontwikkeling",guide_title:"Terugzetten in JW Library",guide_tab_ios:"iPhone / iPad",guide_tab_android:"Android",guide_tab_other:"Overig / computer",guide_warning:"Terugzetten vervangt de aantekeningen die nu in JW Library staan. Bewaar deze samengevoegde back-up als je hoofdexemplaar.",guide_done:"Begrepen",guide_export_title:"Exporteren uit JW Library",guide_mode_export:"Back-ups exporteren",guide_mode_restore:"Samengevoegd bestand terugzetten",cele_highlights:"Bekijk je statistieken",cele_addshared:"Aantekeningen toevoegen die een vriend deelde",perf_title:"Prestaties van het samenvoegen",perf_prepare:"Voorbereiden",perf_merge:"Samenvoegen",perf_package:"Inpakken",perf_tip_large:"Grote bibliotheek — voeg voor sneller samenvoegen minder bestanden tegelijk samen of gebruik het uitpakken op datumbereik.",cele_top_medals:"Je beste medailles",cele_awards_btn:"Bekijk je onderscheidingen →"},ro:{close:"Închide",cele_title:"Îmbinare finalizată",cele_subtitle:"Ți-ai combinat copiile de rezervă într-un singur fișier unificat.",stat_notes:"notițe",stat_highlights:"evidențieri",stat_bookmarks:"semne de carte",stat_tags:"etichete",cele_download:"Descarcă copia de rezervă îmbinată",cele_redownload:"Descarcă din nou",cele_downloading:"Fișierul tău se descarcă…",cele_browse:"Răsfoiește rezultatul îmbinării",cele_restore:"Restaurează în JW Library",cele_demo_title:"Aceea a fost o demonstrație cu date de probă",cele_demo_body:"Ești gata să încerci cu propriile tale copii de rezervă JW Library?",cele_demo_cta:"Folosește fișierele mele reale",donate_prompt:"Ți s-a părut util JW Sync?",donate_cta:"Sprijină dezvoltarea",guide_title:"Cum restaurezi în JW Library",guide_tab_ios:"iPhone / iPad",guide_tab_android:"Android",guide_tab_other:"Altele / Desktop",guide_warning:"Restaurarea înlocuiește notițele aflate acum în JW Library. Păstrează această copie de rezervă îmbinată drept exemplarul tău principal.",guide_done:"Am înțeles",guide_export_title:"Cum exporți din JW Library",guide_mode_export:"Exportă copii de rezervă",guide_mode_restore:"Restaurează fișierul îmbinat",cele_highlights:"Vezi-ți statisticile",cele_addshared:"Adaugă notițe partajate de un prieten",perf_title:"Performanța îmbinării",perf_prepare:"Pregătire",perf_merge:"Îmbinare",perf_package:"Împachetare",perf_tip_large:"Bibliotecă mare — pentru îmbinări mai rapide, combină mai puține fișiere odată sau folosește extragerea pe interval de date.",cele_top_medals:"Medaliile tale de top",cele_awards_btn:"Explorează-ți premiile →"},id:{close:"Tutup",cele_title:"Penggabungan selesai",cele_subtitle:"Anda telah menyatukan cadangan Anda menjadi satu berkas.",stat_notes:"catatan",stat_highlights:"sorotan",stat_bookmarks:"penanda",stat_tags:"label",cele_download:"Unduh cadangan gabungan",cele_redownload:"Unduh lagi",cele_downloading:"Berkas Anda sedang diunduh…",cele_browse:"Telusuri hasil gabungan",cele_restore:"Pulihkan ke JW Library",cele_demo_title:"Itu tadi demo dengan data contoh",cele_demo_body:"Siap mencobanya dengan cadangan JW Library Anda sendiri?",cele_demo_cta:"Pakai berkas asli saya",donate_prompt:"Merasa JW Sync bermanfaat?",donate_cta:"Dukung pengembangannya",guide_title:"Cara memulihkan ke JW Library",guide_tab_ios:"iPhone / iPad",guide_tab_android:"Android",guide_tab_other:"Lainnya / Komputer",guide_warning:"Memulihkan akan mengganti catatan yang ada di JW Library saat ini. Simpanlah cadangan gabungan ini sebagai salinan utama Anda.",guide_done:"Mengerti",guide_export_title:"Cara mengekspor dari JW Library",guide_mode_export:"Ekspor cadangan",guide_mode_restore:"Pulihkan berkas gabungan",cele_highlights:"Lihat Statistik Anda",cele_addshared:"Tambahkan catatan yang dibagikan teman",perf_title:"Kinerja penggabungan",perf_prepare:"Persiapan",perf_merge:"Penggabungan",perf_package:"Pengemasan",perf_tip_large:"Perpustakaan besar — agar penggabungan lebih cepat, satukan lebih sedikit berkas sekaligus atau gunakan pengambilan berdasarkan rentang tanggal.",cele_top_medals:"Medali teratas Anda",cele_awards_btn:"Jelajahi Penghargaan Anda →"},hi:{close:"बंद करें",cele_title:"मर्ज पूरा हुआ",cele_subtitle:"आपने अपने बैकअप एक ही फ़ाइल में जोड़ दिए।",stat_notes:"नोट",stat_highlights:"हाइलाइट",stat_bookmarks:"बुकमार्क",stat_tags:"टैग",cele_download:"मर्ज किया बैकअप डाउनलोड करें",cele_redownload:"फिर से डाउनलोड करें",cele_downloading:"आपकी फ़ाइल डाउनलोड हो रही है…",cele_browse:"मर्ज का नतीजा देखें",cele_restore:"JW Library में रीस्टोर करें",cele_demo_title:"वह नमूना डेटा के साथ डेमो था",cele_demo_body:"अपने असली JW Library बैकअप के साथ आज़माने के लिए तैयार हैं?",cele_demo_cta:"मेरी असली फ़ाइलें इस्तेमाल करें",donate_prompt:"JW Sync उपयोगी लगा?",donate_cta:"विकास में सहयोग दें",guide_title:"JW Library में कैसे रीस्टोर करें",guide_tab_ios:"iPhone / iPad",guide_tab_android:"Android",guide_tab_other:"अन्य / कंप्यूटर",guide_warning:"रीस्टोर करने पर JW Library में अभी मौजूद नोट बदल जाते हैं। इस मर्ज किए बैकअप को अपनी मुख्य प्रति के रूप में रखें।",guide_done:"समझ गया",guide_export_title:"JW Library से एक्सपोर्ट कैसे करें",guide_mode_export:"बैकअप एक्सपोर्ट करें",guide_mode_restore:"मर्ज की फ़ाइल रीस्टोर करें",cele_highlights:"अपने आँकड़े देखें",cele_addshared:"दोस्त के साझा किए नोट जोड़ें",perf_title:"मर्ज की कारगुज़ारी",perf_prepare:"तैयारी",perf_merge:"मर्ज",perf_package:"पैकेजिंग",perf_tip_large:"बड़ी लाइब्रेरी — तेज़ मर्ज के लिए एक बार में कम फ़ाइलें जोड़ें या तारीख़ की सीमा वाला निष्कर्षण इस्तेमाल करें।",cele_top_medals:"आपके शीर्ष पदक",cele_awards_btn:"अपनी उपलब्धियाँ देखें →"},hu:{close:"Bezárás",cele_title:"Az egyesítés kész",cele_subtitle:"Egyetlen egységes fájlba fűzted össze a mentéseidet.",stat_notes:"jegyzet",stat_highlights:"kiemelés",stat_bookmarks:"könyvjelző",stat_tags:"címke",cele_download:"Egyesített mentés letöltése",cele_redownload:"Letöltés újra",cele_downloading:"A fájlod letöltődik…",cele_browse:"Az egyesített eredmény böngészése",cele_restore:"Visszaállítás a JW Librarybe",cele_demo_title:"Ez egy bemutató volt mintaadatokkal",cele_demo_body:"Kipróbálod a saját JW Library-mentéseiddel?",cele_demo_cta:"A saját fájljaimat használom",donate_prompt:"Hasznosnak találtad a JW Syncet?",donate_cta:"Támogasd a fejlesztést",guide_title:"Hogyan állítsd vissza a JW Librarybe",guide_tab_ios:"iPhone / iPad",guide_tab_android:"Android",guide_tab_other:"Egyéb / Asztali gép",guide_warning:"A visszaállítás lecseréli a JW Libraryben jelenleg lévő jegyzeteket. Ezt az egyesített mentést tartsd meg fő példányként.",guide_done:"Értem",guide_export_title:"Hogyan exportálj a JW Libraryből",guide_mode_export:"Mentések exportálása",guide_mode_restore:"Egyesített fájl visszaállítása",cele_highlights:"Nézd meg a statisztikáidat",cele_addshared:"Barát által megosztott jegyzetek hozzáadása",perf_title:"Az egyesítés teljesítménye",perf_prepare:"Előkészítés",perf_merge:"Egyesítés",perf_package:"Csomagolás",perf_tip_large:"Nagy könyvtár — a gyorsabb egyesítéshez fűzz össze egyszerre kevesebb fájlt, vagy használd a dátumtartomány szerinti kinyerést.",cele_top_medals:"A legjobb érmeid",cele_awards_btn:"Fedezd fel az elismeréseidet →"},vi:{close:"Đóng",cele_title:"Hợp nhất xong",cele_subtitle:"Bạn đã gộp các bản sao lưu thành một tập tin thống nhất.",stat_notes:"ghi chú",stat_highlights:"phần tô màu",stat_bookmarks:"dấu trang",stat_tags:"thẻ",cele_download:"Tải bản sao lưu đã hợp nhất",cele_redownload:"Tải lại lần nữa",cele_downloading:"Tập tin của bạn đang được tải về…",cele_browse:"Xem kết quả hợp nhất",cele_restore:"Khôi phục vào JW Library",cele_demo_title:"Đó là bản dùng thử với dữ liệu mẫu",cele_demo_body:"Sẵn sàng thử với chính bản sao lưu JW Library của bạn chưa?",cele_demo_cta:"Dùng tập tin thật của tôi",donate_prompt:"Thấy JW Sync hữu ích chứ?",donate_cta:"Ủng hộ việc phát triển",guide_title:"Cách khôi phục vào JW Library",guide_tab_ios:"iPhone / iPad",guide_tab_android:"Android",guide_tab_other:"Khác / Máy tính",guide_warning:"Việc khôi phục sẽ thay thế các ghi chú hiện có trong JW Library. Hãy giữ bản sao lưu đã hợp nhất này làm bản chính của bạn.",guide_done:"Đã hiểu",guide_export_title:"Cách xuất từ JW Library",guide_mode_export:"Xuất bản sao lưu",guide_mode_restore:"Khôi phục tập tin đã hợp nhất",cele_highlights:"Xem thống kê của bạn",cele_addshared:"Thêm ghi chú bạn bè chia sẻ",perf_title:"Hiệu năng hợp nhất",perf_prepare:"Chuẩn bị",perf_merge:"Hợp nhất",perf_package:"Đóng gói",perf_tip_large:"Thư viện lớn — để hợp nhất nhanh hơn, hãy gộp ít tập tin hơn mỗi lần hoặc dùng cách trích theo khoảng ngày.",cele_top_medals:"Các huy hiệu nổi bật của bạn",cele_awards_btn:"Khám phá thành tích của bạn →"},"yue-Hant":{close:"閂咗佢",cele_title:"合併完成",cele_subtitle:"你已經將各個備份合埋成一個統一嘅檔案。",stat_notes:"條筆記",stat_highlights:"處標註",stat_bookmarks:"個書籤",stat_tags:"個標籤",cele_download:"下載合併好嘅備份",cele_redownload:"再下載一次",cele_downloading:"你嘅檔案下載緊……",cele_browse:"瀏覽合併結果",cele_restore:"還原去 JW Library",cele_demo_title:"頭先係用範例資料嘅示範",cele_demo_body:"準備好用你自己嘅 JW Library 備份試吓未？",cele_demo_cta:"用我自己嘅檔案",donate_prompt:"覺得 JW Sync 有用？",donate_cta:"支持開發",guide_title:"點樣還原去 JW Library",guide_tab_ios:"iPhone / iPad",guide_tab_android:"Android",guide_tab_other:"其他 / 電腦",guide_warning:"還原會取代 JW Library 而家嘅筆記。請將呢個合併好嘅備份留做主備份。",guide_done:"明白喇",guide_export_title:"點樣由 JW Library 匯出",guide_mode_export:"匯出備份",guide_mode_restore:"還原合併檔案",cele_highlights:"睇你嘅統計",cele_addshared:"加入朋友分享嘅筆記",perf_title:"合併效能",perf_prepare:"準備",perf_merge:"合併",perf_package:"打包",perf_tip_large:"書庫幾大——想快啲合併，可以每次少合併幾個檔案，或者用日期範圍抽取。",cele_top_medals:"你最出色嘅獎章",cele_awards_btn:"睇吓你嘅成就 →"},"zh-Hant":{close:"關閉",cele_title:"合併完成",cele_subtitle:"你已把各個備份合併成了一個統一的檔案。",stat_notes:"條筆記",stat_highlights:"處標註",stat_bookmarks:"個書籤",stat_tags:"個標籤",cele_download:"下載合併後的備份",cele_redownload:"再次下載",cele_downloading:"檔案正在下載……",cele_browse:"瀏覽合併結果",cele_restore:"還原到 JW Library",cele_demo_title:"剛才是使用示例資料的演示",cele_demo_body:"準備好用你自己的 JW Library 備份試試了嗎？",cele_demo_cta:"使用我自己的檔案",donate_prompt:"覺得 JW Sync 有用嗎？",donate_cta:"支援開發",guide_title:"如何還原到 JW Library",guide_tab_ios:"iPhone / iPad",guide_tab_android:"Android",guide_tab_other:"其他 / 電腦",guide_warning:"還原會替換 JW Library 中現有的筆記。請把這個合併後的備份儲存為主備份。",guide_done:"知道了",guide_export_title:"如何從 JW Library 匯出",guide_mode_export:"匯出備份",guide_mode_restore:"還原合併檔案",cele_highlights:"檢視你的統計",cele_addshared:"新增朋友分享的筆記",perf_title:"合併效能",perf_prepare:"準備",perf_merge:"合併",perf_package:"打包",perf_tip_large:"書庫較大——想要更快合併，可以每次少合併幾個檔案，或使用按日期範圍提取。",cele_top_medals:"你的頂級獎章",cele_awards_btn:"檢視你的成就 →"},"zh-Hans":{close:"关闭",cele_title:"合并完成",cele_subtitle:"你已把各个备份合并成了一个统一的文件。",stat_notes:"条笔记",stat_highlights:"处标注",stat_bookmarks:"个书签",stat_tags:"个标签",cele_download:"下载合并后的备份",cele_redownload:"再次下载",cele_downloading:"文件正在下载……",cele_browse:"浏览合并结果",cele_restore:"还原到 JW Library",cele_demo_title:"刚才是使用示例数据的演示",cele_demo_body:"准备好用你自己的 JW Library 备份试试了吗？",cele_demo_cta:"使用我自己的文件",donate_prompt:"觉得 JW Sync 有用吗？",donate_cta:"支持开发",guide_title:"如何还原到 JW Library",guide_tab_ios:"iPhone / iPad",guide_tab_android:"Android",guide_tab_other:"其他 / 电脑",guide_warning:"还原会替换 JW Library 中现有的笔记。请把这个合并后的备份保存为主备份。",guide_done:"知道了",guide_export_title:"如何从 JW Library 导出",guide_mode_export:"导出备份",guide_mode_restore:"还原合并文件",cele_highlights:"查看你的统计",cele_addshared:"添加朋友分享的笔记",perf_title:"合并性能",perf_prepare:"准备",perf_merge:"合并",perf_package:"打包",perf_tip_large:"书库较大——想要更快合并，可以每次少合并几个文件，或使用按日期范围提取。",cele_top_medals:"你的顶级奖章",cele_awards_btn:"查看你的成就 →"},pl:{close:"Zamknij",cele_title:"Scalanie zakończone",cele_subtitle:"Połączyłeś swoje kopie zapasowe w jeden wspólny plik.",stat_notes:"notatek",stat_highlights:"wyróżnień",stat_bookmarks:"zakładek",stat_tags:"etykiet",cele_download:"Pobierz scaloną kopię",cele_redownload:"Pobierz ponownie",cele_downloading:"Twój plik jest pobierany…",cele_browse:"Przejrzyj scalony wynik",cele_restore:"Przywróć do JW Library",cele_demo_title:"To była demonstracja na przykładowych danych",cele_demo_body:"Gotowy, aby spróbować z własnymi kopiami zapasowymi JW Library?",cele_demo_cta:"Użyj moich prawdziwych plików",donate_prompt:"JW Sync okazał się przydatny?",donate_cta:"Wesprzyj rozwój",guide_title:"Jak przywrócić do JW Library",guide_tab_ios:"iPhone / iPad",guide_tab_android:"Android",guide_tab_other:"Inne / Komputer",guide_warning:"Przywracanie zastępuje notatki obecnie znajdujące się w JW Library. Zachowaj tę scaloną kopię jako główną.",guide_done:"Rozumiem",guide_export_title:"Jak wyeksportować z JW Library",guide_mode_export:"Eksport kopii zapasowych",guide_mode_restore:"Przywracanie scalonego pliku",cele_highlights:"Zobacz swoje statystyki",cele_addshared:"Dodaj notatki udostępnione przez znajomego",perf_title:"Wydajność scalania",perf_prepare:"Przygotowanie",perf_merge:"Scalanie",perf_package:"Pakowanie",perf_tip_large:"Duża biblioteka — aby scalać szybciej, łącz mniej plików naraz lub użyj wyboru zakresu dat.",cele_top_medals:"Twoje najlepsze medale",cele_awards_btn:"Zobacz swoje osiągnięcia →"},uk:{close:"Закрити",cele_title:"Об'єднання завершено",cele_subtitle:"Ви поєднали свої резервні копії в один спільний файл.",stat_notes:"нотаток",stat_highlights:"виділень",stat_bookmarks:"закладок",stat_tags:"тегів",cele_download:"Завантажити об'єднану копію",cele_redownload:"Завантажити ще раз",cele_downloading:"Ваш файл завантажується…",cele_browse:"Переглянути об'єднаний результат",cele_restore:"Відновити в JW Library",cele_demo_title:"Це була демонстрація зі зразковими даними",cele_demo_body:"Готові спробувати з власними резервними копіями JW Library?",cele_demo_cta:"Використати мої справжні файли",donate_prompt:"JW Sync став вам у пригоді?",donate_cta:"Підтримати розробку",guide_title:"Як відновити в JW Library",guide_tab_ios:"iPhone / iPad",guide_tab_android:"Android",guide_tab_other:"Інше / Комп'ютер",guide_warning:"Відновлення замінює нотатки, які зараз є в JW Library. Зберігайте цю об'єднану копію як основну.",guide_done:"Зрозуміло",guide_export_title:"Як експортувати з JW Library",guide_mode_export:"Експорт резервних копій",guide_mode_restore:"Відновлення об'єднаного файлу",cele_highlights:"Переглянути статистику",cele_addshared:"Додати нотатки, якими поділився друг",perf_title:"Продуктивність об'єднання",perf_prepare:"Підготовка",perf_merge:"Об'єднання",perf_package:"Пакування",perf_tip_large:"Велика бібліотека — щоб об'єднувати швидше, поєднуйте менше файлів за раз або використовуйте вибірку за діапазоном дат.",cele_top_medals:"Ваші найкращі медалі",cele_awards_btn:"Переглянути свої нагороди →"},he:{close:"סגירה",cele_title:"המיזוג הושלם",cele_subtitle:"איחדתם את הגיבויים שלכם לקובץ אחד מאוחד.",stat_notes:"הערות",stat_highlights:"הדגשות",stat_bookmarks:"סימניות",stat_tags:"תוויות",cele_download:"הורדת הגיבוי הממוזג",cele_redownload:"הורדה שוב",cele_downloading:"הקובץ שלכם יורד…",cele_browse:"עיון בתוצאה הממוזגת",cele_restore:"שחזור אל JW Library",cele_demo_title:"זו הייתה הדגמה עם נתוני דוגמה",cele_demo_body:"מוכנים לנסות עם הגיבויים האמיתיים שלכם מ-JW Library?",cele_demo_cta:"להשתמש בקבצים האמיתיים שלי",donate_prompt:"JW Sync היה מועיל לכם?",donate_cta:"תמכו בפיתוח",guide_title:"איך לשחזר אל JW Library",guide_tab_ios:"iPhone / iPad",guide_tab_android:"אנדרואיד",guide_tab_other:"אחר / מחשב",guide_warning:"השחזור מחליף את ההערות שנמצאות כעת ב-JW Library. שמרו את הגיבוי הממוזג הזה כעותק הראשי שלכם.",guide_done:"הבנתי",guide_export_title:"איך לייצא מ-JW Library",guide_mode_export:"ייצוא גיבויים",guide_mode_restore:"שחזור הקובץ הממוזג",cele_highlights:"צפייה בסטטיסטיקה שלכם",cele_addshared:"הוספת הערות שחבר שיתף",perf_title:"ביצועי המיזוג",perf_prepare:"הכנה",perf_merge:"מיזוג",perf_package:"אריזה",perf_tip_large:"ספרייה גדולה — למיזוג מהיר יותר, אחדו פחות קבצים בבת אחת או השתמשו בחילוץ לפי טווח תאריכים.",cele_top_medals:"המדליות המובילות שלכם",cele_awards_btn:"גלו את ההישגים שלכם →"},ar:{close:"إغلاق",cele_title:"اكتمل الدمج",cele_subtitle:"دمجت نسخك الاحتياطية في ملف واحد موحّد.",stat_notes:"ملاحظة",stat_highlights:"تظليل",stat_bookmarks:"علامة مرجعية",stat_tags:"وسم",cele_download:"نزّل النسخة الاحتياطية المدمجة",cele_redownload:"نزّل مرة أخرى",cele_downloading:"جارٍ تنزيل ملفك…",cele_browse:"تصفّح النتيجة المدمجة",cele_restore:"استعادة إلى JW Library",cele_demo_title:"كان ذلك عرضًا تجريبيًا ببيانات نموذجية",cele_demo_body:"هل أنت مستعد لتجربته بنسخك الاحتياطية الحقيقية من JW Library؟",cele_demo_cta:"استخدم ملفاتي الحقيقية",donate_prompt:"هل وجدت JW Sync مفيدًا؟",donate_cta:"ادعم التطوير",guide_title:"كيفية الاستعادة إلى JW Library",guide_tab_ios:"iPhone / iPad",guide_tab_android:"أندرويد",guide_tab_other:"أخرى / حاسوب",guide_warning:"الاستعادة تستبدل الملاحظات الموجودة حاليًا في JW Library. احتفظ بهذه النسخة المدمجة بوصفها نسختك الرئيسية.",guide_done:"فهمت",guide_export_title:"كيفية التصدير من JW Library",guide_mode_export:"تصدير النسخ الاحتياطية",guide_mode_restore:"استعادة الملف المدمج",cele_highlights:"اعرض إحصاءاتك",cele_addshared:"أضف ملاحظات شاركها صديق",perf_title:"أداء الدمج",perf_prepare:"التحضير",perf_merge:"الدمج",perf_package:"التغليف",perf_tip_large:"مكتبة كبيرة — لدمج أسرع، اجمع ملفات أقل في المرة الواحدة أو استخدم الاستخراج حسب نطاق التاريخ.",cele_top_medals:"أفضل أوسمتك",cele_awards_btn:"استكشف أوسمتك ←"}};
  var SHARE_I18N={
   ...
   ceb:{cele_share:'Ipaambit',share_headline:'Nahiusa ang library!',share_preview_title:'Ipaambit ang imong kalampusan',share_preview_body:'I-post kini nga card sa imong story ug tabangi ang usa ka higala nga makakita sa libre ug pribado nga paagi sa paghiusa sa ilang JW Library notes.',share_save:'I-save ang hulagway',share_copy:'Kopyaha ang caption',share_copied:'Nakopya ang caption — i-paste kini sa imong post!',share_saved:'Na-save ang hulagway! Idugang kini sa imong Instagram story o post.',share_hint:'Sa telepono, i-tap ang Share ug pilia ang Instagram. Sa kompyuter, i-save ang hulagway ug i-upload kini sa Instagram.',share_text:'Bag-o lang nako gihiusa ang akong JW Library notes gamit ang JW Sync — usa ka libre ug pribado nga tool nga naghiusa sa imong mga nota, highlight ug bookmark gikan sa tanan nimong device. https://jwsync.org'},el:{cele_share:"Κοινοποίηση",share_headline:"Η βιβλιοθήκη συγχωνεύτηκε!",share_preview_title:"Μοιραστείτε την πρόοδό σας",share_preview_body:"Δημοσιεύστε αυτή την κάρτα στην ιστορία σας — και βοηθήστε έναν φίλο να ανακαλύψει έναν δωρεάν, ιδιωτικό τρόπο να συνδυάσει τις σημειώσεις του από το JW Library.",share_save:"Αποθήκευση εικόνας",share_copy:"Αντιγραφή λεζάντας",share_copied:"Η λεζάντα αντιγράφηκε — επικολλήστε την μαζί με τη δημοσίευσή σας!",share_saved:"Η εικόνα αποθηκεύτηκε! Προσθέστε την στην ιστορία ή στη δημοσίευσή σας στο Instagram.",share_hint:"Σε κινητό, πατήστε Κοινοποίηση και επιλέξτε Instagram. Σε υπολογιστή, αποθηκεύστε την εικόνα και έπειτα ανεβάστε την στο Instagram.",share_text:"Μόλις συγχώνευσα τις σημειώσεις μου από το JW Library με το JW Sync — ένα δωρεάν, ιδιωτικό εργαλείο που συνδυάζει τις σημειώσεις, τις επισημάνσεις και τους σελιδοδείκτες σας από όλες τις συσκευές σας. https://jwsync.org"},sw:{cele_share:"Shiriki",share_headline:"Maktaba imeunganishwa!",share_preview_title:"Shiriki maendeleo yako",share_preview_body:"Chapisha kadi hii kwenye hadithi yako — na umsaidie rafiki agundue njia ya bure na ya faragha ya kuunganisha madokezo yake ya JW Library.",share_save:"Hifadhi picha",share_copy:"Nakili maelezo",share_copied:"Maelezo yamenakiliwa — yabandike pamoja na chapisho lako!",share_saved:"Picha imehifadhiwa! Iweke kwenye hadithi yako ya Instagram au uichapishe.",share_hint:"Kwenye simu, gusa Shiriki kisha uchague Instagram. Kwenye kompyuta, hifadhi picha, kisha uipakie kwenye Instagram.",share_text:"Nimeunganisha madokezo yangu ya JW Library kwa kutumia JW Sync — kifaa cha bure na cha faragha kinachounganisha madokezo, viangazio na alamisho kutoka vifaa vyako vyote. https://jwsync.org"},nl:{cele_share:"Delen",share_headline:"Bibliotheek samengevoegd!",share_preview_title:"Deel je voortgang",share_preview_body:"Plaats deze kaart in je verhaal — en help een vriend een gratis, privémanier ontdekken om zijn JW Library-aantekeningen samen te voegen.",share_save:"Afbeelding opslaan",share_copy:"Tekst kopiëren",share_copied:"Tekst gekopieerd — plak hem bij je bericht!",share_saved:"Afbeelding opgeslagen! Voeg hem toe aan je Instagram-verhaal of -bericht.",share_hint:"Tik op een telefoon op Delen en kies Instagram. Sla de afbeelding op een computer op en upload hem daarna naar Instagram.",share_text:"Ik heb net mijn JW Library-aantekeningen samengevoegd met JW Sync — een gratis, privétool die je aantekeningen, markeringen en bladwijzers van al je apparaten combineert. https://jwsync.org"},ro:{cele_share:"Partajează",share_headline:"Bibliotecă îmbinată!",share_preview_title:"Împărtășește-ți progresul",share_preview_body:"Postează cardul acesta la story — și ajută un prieten să descopere o modalitate gratuită și privată de a-și combina notițele din JW Library.",share_save:"Salvează imaginea",share_copy:"Copiază textul",share_copied:"Text copiat — lipește-l odată cu postarea!",share_saved:"Imagine salvată! Adaug-o la story sau la o postare pe Instagram.",share_hint:"Pe telefon, atinge Partajează și alege Instagram. Pe calculator, salvează imaginea, apoi încarc-o pe Instagram.",share_text:"Tocmai mi-am îmbinat notițele din JW Library cu JW Sync — un instrument gratuit și privat care îți combină notițele, evidențierile și semnele de carte de pe toate dispozitivele. https://jwsync.org"},id:{cele_share:"Bagikan",share_headline:"Perpustakaan tergabung!",share_preview_title:"Bagikan kemajuan Anda",share_preview_body:"Bagikan kartu ini ke cerita Anda — sekaligus bantu teman menemukan cara gratis dan pribadi untuk menggabungkan catatan JW Library mereka.",share_save:"Simpan gambar",share_copy:"Salin teks",share_copied:"Teks tersalin — tempelkan bersama unggahan Anda!",share_saved:"Gambar tersimpan! Tambahkan ke cerita atau unggahan Instagram Anda.",share_hint:"Di ponsel, ketuk Bagikan lalu pilih Instagram. Di komputer, simpan gambarnya, lalu unggah ke Instagram.",share_text:"Saya baru saja menggabungkan catatan JW Library saya dengan JW Sync — alat gratis dan pribadi yang menyatukan catatan, sorotan, dan penanda dari semua perangkat Anda. https://jwsync.org"},hi:{cele_share:"साझा करें",share_headline:"लाइब्रेरी मर्ज हो गई!",share_preview_title:"अपनी प्रगति साझा करें",share_preview_body:"इस कार्ड को अपनी स्टोरी पर लगाएँ — और किसी दोस्त को JW Library के नोट जोड़ने का मुफ़्त, निजी तरीका बताएँ।",share_save:"तस्वीर सेव करें",share_copy:"कैप्शन कॉपी करें",share_copied:"कैप्शन कॉपी हो गया — इसे अपनी पोस्ट के साथ चिपकाएँ!",share_saved:"तस्वीर सेव हो गई! इसे अपनी Instagram स्टोरी या पोस्ट में जोड़ें।",share_hint:"फ़ोन पर साझा करें दबाकर Instagram चुनें। कंप्यूटर पर तस्वीर सेव करके Instagram पर अपलोड करें।",share_text:"मैंने अभी JW Sync से अपने JW Library नोट मर्ज किए — यह एक मुफ़्त, निजी टूल है जो आपके सभी डिवाइस के नोट, हाइलाइट और बुकमार्क जोड़ देता है। https://jwsync.org"},hu:{cele_share:"Megosztás",share_headline:"A könyvtár egyesítve!",share_preview_title:"Oszd meg, hol tartasz",share_preview_body:"Tedd ki ezt a kártyát a történetedbe — és segíts egy barátodnak felfedezni egy ingyenes, magánjellegű módot a JW Library-jegyzetei egyesítésére.",share_save:"Kép mentése",share_copy:"Felirat másolása",share_copied:"Felirat kimásolva — illeszd be a bejegyzésed mellé!",share_saved:"Kép elmentve! Add hozzá az Instagram-történetedhez vagy -bejegyzésedhez.",share_hint:"Telefonon koppints a Megosztásra, és válaszd az Instagramot. Számítógépen mentsd el a képet, majd töltsd fel az Instagramra.",share_text:"Most egyesítettem a JW Library-jegyzeteimet a JW Synckel — ez egy ingyenes, magánjellegű eszköz, amely az összes eszközödről összefésüli a jegyzeteidet, kiemeléseidet és könyvjelzőidet. https://jwsync.org"},vi:{cele_share:"Chia sẻ",share_headline:"Đã hợp nhất thư viện!",share_preview_title:"Chia sẻ tiến bộ của bạn",share_preview_body:"Đăng tấm thiệp này lên tin của bạn — và giúp một người bạn khám phá cách miễn phí, riêng tư để gộp ghi chú JW Library của họ.",share_save:"Lưu hình ảnh",share_copy:"Chép chú thích",share_copied:"Đã chép chú thích — hãy dán vào bài đăng của bạn!",share_saved:"Đã lưu hình ảnh! Thêm vào tin hoặc bài đăng Instagram của bạn.",share_hint:"Trên điện thoại, nhấn Chia sẻ rồi chọn Instagram. Trên máy tính, lưu hình ảnh rồi tải lên Instagram.",share_text:"Mình vừa hợp nhất ghi chú JW Library bằng JW Sync — một công cụ miễn phí, riêng tư giúp gộp ghi chú, phần tô màu và dấu trang từ mọi thiết bị của bạn. https://jwsync.org"},"yue-Hant":{cele_share:"分享",share_headline:"書庫合併好喇！",share_preview_title:"分享你嘅進度",share_preview_body:"將呢張卡放上限時動態——順便話畀朋友知，有個免費又私隱嘅方法可以將各部裝置嘅 JW Library 筆記合埋。",share_save:"儲存圖片",share_copy:"複製文字",share_copied:"文字已複製——出帖嗰陣貼上去就得！",share_saved:"圖片已儲存！可以加落你嘅 Instagram 限時動態或者帖文。",share_hint:"喺手機上撳分享，然後揀 Instagram。喺電腦上先儲存圖片，再上載去 Instagram。",share_text:"我啱啱用 JW Sync 合併咗自己嘅 JW Library 筆記——呢個係免費又保護私隱嘅工具，可以將你所有裝置上嘅筆記、標註同書籤合埋一齊。https://jwsync.org"},"zh-Hant":{cele_share:"分享",share_headline:"書庫已合併！",share_preview_title:"分享你的進展",share_preview_body:"把這張卡片發到動態——順便讓朋友知道有這樣一個免費、私密的方法，可以把各裝置上的 JW Library 筆記合併起來。",share_save:"儲存圖片",share_copy:"複製文字",share_copied:"文字已複製——釋出時貼上即可！",share_saved:"圖片已儲存！可以新增到你的 Instagram 動態或帖子。",share_hint:"在手機上，點擊分享並選擇 Instagram。在電腦上，先儲存圖片，再上傳到 Instagram。",share_text:"我剛用 JW Sync 合併了自己的 JW Library 筆記——這是一個免費、私密的工具，可以把你所有裝置上的筆記、標註和書籤合併到一起。https://jwsync.org"},"zh-Hans":{cele_share:"分享",share_headline:"书库已合并！",share_preview_title:"分享你的进展",share_preview_body:"把这张卡片发到动态——顺便让朋友知道有这样一个免费、私密的方法，可以把各设备上的 JW Library 笔记合并起来。",share_save:"保存图片",share_copy:"复制文字",share_copied:"文字已复制——发布时粘贴即可！",share_saved:"图片已保存！可以添加到你的 Instagram 动态或帖子。",share_hint:"在手机上，点击分享并选择 Instagram。在电脑上，先保存图片，再上传到 Instagram。",share_text:"我刚用 JW Sync 合并了自己的 JW Library 笔记——这是一个免费、私密的工具，可以把你所有设备上的笔记、标注和书签合并到一起。https://jwsync.org"},pl:{cele_share:"Udostępnij",share_headline:"Biblioteka scalona!",share_preview_title:"Podziel się swoim postępem",share_preview_body:"Opublikuj tę kartę w relacji — i pomóż znajomemu poznać bezpłatny, prywatny sposób na połączenie notatek z JW Library.",share_save:"Zapisz obraz",share_copy:"Kopiuj podpis",share_copied:"Podpis skopiowany — wklej go do swojego posta!",share_saved:"Obraz zapisany! Dodaj go do relacji lub posta na Instagramie.",share_hint:"Na telefonie dotknij Udostępnij i wybierz Instagram. Na komputerze zapisz obraz, a potem prześlij go na Instagram.",share_text:"Właśnie scaliłem swoje notatki z JW Library za pomocą JW Sync — bezpłatnego, prywatnego narzędzia, które łączy notatki, wyróżnienia i zakładki ze wszystkich Twoich urządzeń. https://jwsync.org"},uk:{cele_share:"Поділитися",share_headline:"Бібліотеку об'єднано!",share_preview_title:"Поділіться своїм поступом",share_preview_body:"Опублікуйте цю картку в історії — і допоможіть другові дізнатися про безкоштовний і приватний спосіб поєднати свої нотатки з JW Library.",share_save:"Зберегти зображення",share_copy:"Копіювати підпис",share_copied:"Підпис скопійовано — вставте його у свою публікацію!",share_saved:"Зображення збережено! Додайте його в історію або допис в Instagram.",share_hint:"На телефоні натисніть «Поділитися» і виберіть Instagram. На комп'ютері збережіть зображення, а тоді завантажте його в Instagram.",share_text:"Я щойно об'єднав свої нотатки з JW Library за допомогою JW Sync — безкоштовного і приватного інструмента, який поєднує нотатки, виділення та закладки з усіх ваших пристроїв. https://jwsync.org"},he:{cele_share:"שיתוף",share_headline:"הספרייה מוזגה!",share_preview_title:"שתפו את ההתקדמות שלכם",share_preview_body:"פרסמו את הכרטיס הזה בסטורי — ועזרו לחבר לגלות דרך חינמית ופרטית לאחד את ההערות שלו מ-JW Library.",share_save:"שמירת התמונה",share_copy:"העתקת הכיתוב",share_copied:"הכיתוב הועתק — הדביקו אותו בפרסום!",share_saved:"התמונה נשמרה! הוסיפו אותה לסטורי או לפוסט באינסטגרם.",share_hint:"בטלפון, הקישו על שיתוף ובחרו באינסטגרם. במחשב, שמרו את התמונה ואז העלו אותה לאינסטגרם.",share_text:"בדיוק מיזגתי את ההערות שלי מ-JW Library עם JW Sync — כלי חינמי ופרטי שמאחד הערות, הדגשות וסימניות מכל המכשירים שלכם. https://jwsync.org"},ar:{cele_share:"مشاركة",share_headline:"تم دمج المكتبة!",share_preview_title:"شارِك تقدّمك",share_preview_body:"انشر هذه البطاقة في قصتك — وساعد صديقًا على اكتشاف طريقة مجانية وخاصة لدمج ملاحظات JW Library.",share_save:"حفظ الصورة",share_copy:"نسخ التعليق",share_copied:"تم نسخ التعليق — الصقه مع منشورك!",share_saved:"تم حفظ الصورة! أضفها إلى قصتك أو منشورك على إنستغرام.",share_hint:"على الهاتف، اضغط مشاركة واختر إنستغرام. على الحاسوب، احفظ الصورة ثم ارفعها إلى إنستغرام.",share_text:"دمجت للتو ملاحظات JW Library باستخدام JW Sync — أداة مجانية وخاصة تجمع ملاحظاتك وتظليلاتك وعلاماتك المرجعية من كل أجهزتك. https://jwsync.org"}
  };
  ...
  var SAFE_I18N={
   ...
   ceb:{safe_title:'Pag-restore nga luwas',safe_originals:'Luwas ang imong orihinal nga mga backup — dili kini usbon sa JW Sync. Kini usa ka bag-ong gihiusa nga file.',safe_master:'Tipigi kini nga gihiusa nga file isip imong master backup.'},el:{safe_title:"Ασφαλής επαναφορά",safe_originals:"Τα αρχικά σας αντίγραφα ασφαλείας είναι ασφαλή — το JW Sync δεν τα αλλάζει ποτέ. Αυτό είναι ένα ολοκαίνουργιο συνδυασμένο αρχείο.",safe_master:"Κρατήστε αυτό το συνδυασμένο αρχείο ως το κύριο αντίγραφο ασφαλείας σας."},sw:{safe_title:"Rejesha kwa usalama",safe_originals:"Nakala zako rudufu za awali ziko salama — JW Sync haizibadilishi kamwe. Hili ni faili jipya kabisa lililounganishwa.",safe_master:"Hifadhi faili hili lililounganishwa kuwa nakala yako rudufu kuu."},nl:{safe_title:"Veilig terugzetten",safe_originals:"Je oorspronkelijke back-ups zijn veilig — JW Sync verandert ze nooit. Dit is een compleet nieuw, samengevoegd bestand.",safe_master:"Bewaar dit samengevoegde bestand als je hoofdback-up."},ro:{safe_title:"Restaurează în siguranță",safe_originals:"Copiile tale de rezervă originale sunt în siguranță — JW Sync nu le modifică niciodată. Acesta este un fișier combinat complet nou.",safe_master:"Păstrează acest fișier combinat drept copia ta de rezervă principală."},id:{safe_title:"Pulihkan dengan aman",safe_originals:"Cadangan asli Anda tetap aman — JW Sync tidak pernah mengubahnya. Ini adalah berkas gabungan yang benar-benar baru.",safe_master:"Simpan berkas gabungan ini sebagai cadangan utama Anda."},hi:{safe_title:"सुरक्षित तरीके से रीस्टोर करें",safe_originals:"आपके मूल बैकअप सुरक्षित हैं — JW Sync उन्हें कभी नहीं बदलता। यह एकदम नई, जुड़ी हुई फ़ाइल है।",safe_master:"इस जुड़ी हुई फ़ाइल को अपने मुख्य बैकअप के रूप में रखें।"},hu:{safe_title:"Biztonságos visszaállítás",safe_originals:"Az eredeti biztonsági mentéseid érintetlenek — a JW Sync soha nem módosítja őket. Ez egy teljesen új, egyesített fájl.",safe_master:"Ezt az egyesített fájlt tartsd meg fő biztonsági mentésként."},vi:{safe_title:"Khôi phục an toàn",safe_originals:"Các bản sao lưu gốc của bạn vẫn an toàn — JW Sync không bao giờ thay đổi chúng. Đây là một tập tin kết hợp hoàn toàn mới.",safe_master:"Hãy giữ tập tin kết hợp này làm bản sao lưu chính của bạn."},"yue-Hant":{safe_title:"安全還原",safe_originals:"你原本嘅備份好安全——JW Sync 從來唔會改佢哋。呢個係全新嘅合併檔案。",safe_master:"請將呢個合併檔案留做你嘅主備份。"},"zh-Hant":{safe_title:"安全還原",safe_originals:"你原來的備份都很安全——JW Sync 從不修改它們。這是一個全新的合併檔案。",safe_master:"請把這個合併檔案儲存為你的主備份。"},"zh-Hans":{safe_title:"安全还原",safe_originals:"你原来的备份都很安全——JW Sync 从不修改它们。这是一个全新的合并文件。",safe_master:"请把这个合并文件保存为你的主备份。"},pl:{safe_title:"Bezpieczne przywracanie",safe_originals:"Twoje pierwotne kopie zapasowe są bezpieczne — JW Sync nigdy ich nie zmienia. To zupełnie nowy, połączony plik.",safe_master:"Zachowaj ten połączony plik jako swoją główną kopię zapasową."},uk:{safe_title:"Безпечне відновлення",safe_originals:"Ваші початкові резервні копії в безпеці — JW Sync ніколи їх не змінює. Це цілком новий об'єднаний файл.",safe_master:"Зберігайте цей об'єднаний файл як свою основну резервну копію."},he:{safe_title:"שחזור בבטחה",safe_originals:"הגיבויים המקוריים שלכם בטוחים — JW Sync לעולם לא משנה אותם. זהו קובץ מאוחד חדש לגמרי.",safe_master:"שמרו את הקובץ המאוחד הזה כגיבוי הראשי שלכם."},ar:{safe_title:"استعادة آمنة",safe_originals:"نسخك الاحتياطية الأصلية في أمان — JW Sync لا يغيّرها أبدًا. هذا ملف مدمج جديد تمامًا.",safe_master:"احتفظ بهذا الملف المدمج بوصفه نسختك الاحتياطية الرئيسية."}
  };
